...
public class StdMap extends StdItem implements com.syncleus.aethermud.game.Items.interfaces.RoomMap {
                        ...
                        if ((isReadable())
                            ...
                            if ((msg.targetMessage().length() > 0) && (!msg.targetMessage().startsWith("<S-NAME>"))) {
                                ...
                                for (int i = 0; i < msg.targetMessage().length(); i++) {
                                    ...
                                    } else if (Character.isLetter(c) && (!trans)) {
                ...
                switch (d) {
                    ...
                    case Directions.UP:
                        if (!anythingThatDirection(room, Directions.NORTH))
                            newFavoredY--;
                        else if (!anythingThatDirection(room, Directions.WEST))
                            newFavoredX--;
                        else if (!anythingThatDirection(room, Directions.EAST))
                            newFavoredX++;
                        else if (!anythingThatDirection(room, Directions.SOUTH))
                            newFavoredY++;
                        break;
                    case Directions.DOWN:
                        if (!anythingThatDirection(room, Directions.SOUTH))
                            ...
                            newFavoredX--;
                        else if (!anythingThatDirection(room, Directions.NORTH))
                            newFavoredY--;
                        break;
                }
