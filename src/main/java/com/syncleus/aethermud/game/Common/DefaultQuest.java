...
public class DefaultQuest implements Quest, Tickable, CMObject {
    ...
    private List sortSelect(Environmental E,
        ...
        if (str.equalsIgnoreCase("any")) {
            choices = choices0;
            choices0.add(E);
        } else if (mname.equalsIgnoreCase(str)) {
            choices = choices0;
            choices0.add(E);
        } else if (CMLib.english().containsString(mname, str)) {
            if ((choices == null) || (choices == choices2) || (choices == choices3))
                choices = choices1;
            choices1.add(E);
        } else if (CMLib.english().containsString(mdisp, str)) {
            if ((choices == null) || (choices == choices3))
                choices = choices2;
            choices2.add(E);
        } else if (CMLib.english().containsString(mdesc, str)) {
            if (choices == null)
                choices = choices3;
            choices3.add(E);
        }
    ...
    private TimeClock getMysteryTimeNowFromState() {
        ...
        else if ((questState.mysteryData.whereHappened != null) && (questState.mysteryData.whereHappened.getArea() != null))
            NOW = (TimeClock) questState.mysteryData.whereHappened.getArea().getTimeObj().copyOf();
        else if ((questState.room != null) && (questState.room.getArea() != null))
            NOW = (TimeClock) questState.room.getArea().getTimeObj().copyOf();
        else if (questState.area != null)
        ...
        if ((choices != null) && (choices.size() > 0)) {
            ...
            for (int c = choices.size() - 1; c >= 0; c--) {
                ...
                if ((E instanceof Physical) && (CMLib.flags().isCloaked((Physical) E)))
                    choices.remove(c);
                else if ((!reselect) || (!q.reselectable.contains(E))) {
    ...
    public void parseQuestScript(Vector script, List args, int startLine) {
        ...
        for (int v = 0; v < script.size(); v++) {
            ...
            else if (script.elementAt(v) instanceof List) {
                final int vs = v;
            ...
            if (p.size() > 0) {
                ...
                if (cmd.equals("STEP")) {
                    ...
                    if ((p.size() > 1) && (p.elementAt(1).equalsIgnoreCase("BREAK"))) {
                        ...
                        q.done = true;
                    } else if ((p.size() > 1) && (p.elementAt(1).equalsIgnoreCase("BACK"))) {
                        if (startLine >= 0)
                            q.lastLine = q.startLine;
                    } else if ((p.size() > 1) && (p.elementAt(1).equalsIgnoreCase("AUTO"))) {
                        if (startLine >= 0)
                            q.lastLine = v + 1;
                ...
                if (cmd.equals("RESET")) {
                    ...
                    if (cmd.equals("AREA")) {
                                            ...
                                            for (int i = 0; i < R2.numInhabitants(); i++) {
                                                ...
                                                if ((M2 != null)
                                                    ...
                                                    if (mobType.equalsIgnoreCase("any"))
                                                        choices.add(M2);
                                                    else if ((CMClass.classID(M2).toUpperCase().indexOf(mobType) >= 0)
                                            ...
                                            for (int i = 0; i < R2.numItems(); i++) {
                                                ...
                                                if ((I2 != null)) {
                                                    if (itemType.equalsIgnoreCase("any"))
                                                        choices.add(I2);
                                                    else if (CMClass.classID(I2).toUpperCase().indexOf(itemType) >= 0)
                                                        choices.add(I2);
                                                }
                                            }
                                        }
                        ...
                        else if (q.item.owner() instanceof Room)
                    ...
                    } else if (cmd.equals("PRESERVE"))
                        q.preserveState = CMath.parseIntExpression(p.elementAt(2));
                    else if (cmd.equals("LOCALE") || cmd.equals("LOCALEGROUP") || cmd.equals("LOCALEGROUPAROUND")) {
                        int range = 0;
                        ...
                        } else if (cmd.equals("LOCALEGROUPAROUND")) {
                            q.roomGroup = null;
                            if (p.size() < 3)
                                continue;
                                    ...
                                    if (addAll || CMClass.classID(R2).toUpperCase().indexOf(localeName) >= 0)
                                        ...
                                        if ((dom & Room.INDOORS) > 0) {
                                            if (Room.DOMAIN_INDOORS_DESCS[dom - Room.INDOORS].indexOf(localeName) >= 0)
                                                choices.add(R2);
                                        } else if (Room.DOMAIN_OUTDOOR_DESCS[dom].indexOf(localeName) >= 0)
                                            choices.add(R2);
                                    }
                                }
                            } catch (final NoSuchElementException e) {
                    ...
                    } else if (cmd.equals("ROOM") || cmd.equals("ROOMGROUP") || cmd.equals("ROOMGROUPAROUND")) {
                        int range = 0;
                        if (cmd.equals("ROOM")) {
                            try {
                                q.room = (Room) getObjectIfSpecified(p, args, 2, 0);
                        ...
                        } else if (cmd.equals("ROOMGROUPAROUND")) {
                            q.roomGroup = null;
                            if (p.size() < 3)
                                continue;
                            ...
                            try {
                                ...
                                for (; e.hasNext(); ) {
                                    ...
                                    if (addAll) {
                                        choices = choices0;
                                        choices0.add(R2);
                                    } else if (CMLib.map().getExtendedRoomID(R2).equalsIgnoreCase(localeName)) {
                                        choices = choices0;
                                        choices0.add(R2);
                                    } else if (display.equals(localeName)) {
                                        if ((choices == null) || (choices == choices2) || (choices == choices3))
                                            choices = choices1;
                                        choices1.add(R2);
                                    } else if (CMLib.english().containsString(display, localeName)) {
                                        if ((choices == null) || (choices == choices3))
                                            choices = choices2;
                                        choices2.add(R2);
                                    } else if (CMLib.english().containsString(desc, localeName)) {
                                        if (choices == null)
                                            choices = choices3;
                                        choices3.add(R2);
                                    }
                    ...
                    } else if (cmd.equals("FACTIONGROUP")) {
                        if (q.mysteryData == null)
                            q.mysteryData = new MysteryData();
                        if (p.size() < 3) {
                    ...
                    } else if (cmd.equals("WHEREHAPPENEDGROUP") || cmd.equals("WHEREATGROUP")) {
                        if (q.mysteryData == null)
                            q.mysteryData = new MysteryData();
                    ...
                    } else if (cmd.equals("WHENHAPPENEDGROUP") || cmd.equals("WHENATGROUP")) {
                        if (q.mysteryData == null)
                            q.mysteryData = new MysteryData();
                        List<TimeClock> V2;
                        TimeClock TC = null;
                    ...
                    } else if (cmd.equals("WHENHAPPENED")
                        || cmd.equals("WHENAT")) {
                        if (q.mysteryData == null)
                            q.mysteryData = new MysteryData();
                        ...
                        if (cmd.equals("WHENHAPPENED"))
                            ...
                            q.mysteryData.whenAt = TC;
                    } else if (cmd.equals("MOTIVEGROUP") || cmd.equals("ACTIONGROUP")) {
                        if (q.mysteryData == null)
                            q.mysteryData = new MysteryData();
                        List<String> V2 = null;
                        int num = -1;
                    ...
                    } else if (cmd.equals("WHEREHAPPENED")
                        || cmd.equals("WHEREAT")) {
                        if (q.mysteryData == null)
                            q.mysteryData = new MysteryData();
                        ...
                        q.envObject = q.room;
                    } else if (cmd.equals("TARGETGROUP")
                        ...
                        } else if (finalE instanceof Item) {
                        ...
                        } else if (q.envObject instanceof Item) {
                    ...
                    if (cmd.equals("MOB") || cmd.equals("MOBGROUP")) {
                        ...
                        if (q.room != null)
                            q.area = q.room.getArea();
                    } else if (cmd.equals("ITEM") || cmd.equals("ITEMGROUP")) {
                        if (q.loadedItems.size() == 0) {
                    ...
                    if (cmd.equals("FOLLOWER")) {
                    ...
                    } else if (cmd.equals("ITEM") || (cmd.equalsIgnoreCase("ITEMS"))) {
                        ...
                        while (proceed && (p.size() > 2)) {
                            ...
                            if (word.equalsIgnoreCase("SAVABLE")) {
                                savable = true;
                                proceed = true;
                            } else if (word.equalsIgnoreCase("GLOBAL")) {
                                scope = "";
                                proceed = true;
                            } else if (word.equalsIgnoreCase("INDIVIDUAL") || word.equals("*")) {
                                scope = "*";
                                proceed = true;
                            }
                            if (proceed)
    ...
    public void enterRunningState() {
        if (duration() >= 0) {
            ...
            if (duration() == 0)
                ticksRemaining = 1;
            else if ((resetData != null) && (resetData[1] > 0))
                        ...
                        for (int i = questState.addons.size() - 1; i >= 0; i--) {
                            try {
                                ...
                                if (O instanceof String) {
                                    ...
                                    else if ((E instanceof MOB) && CMStrings.contains(((Physical) E).basePhyStats().getStatCodes(), stat.toUpperCase().trim())) {
                                        ((Physical) E).basePhyStats().setStat(stat.toUpperCase().trim(), parms);
                                        ((Physical) E).recoverPhyStats();
                                    } else if ((E instanceof MOB) && (CMStrings.contains(CharStats.CODES.NAMES(), stat.toUpperCase().trim()))) {
                                        ((MOB) E).baseCharStats().setStat(CMParms.indexOf(CharStats.CODES.NAMES(), stat.toUpperCase().trim()), CMath.s_int(parms));
                                        ((MOB) E).recoverCharStats();
                                    } else if ((E instanceof MOB) && CMStrings.contains(((MOB) E).baseState().getStatCodes(), stat)) {
                                ...
                                } else if (O instanceof ScriptingEngine) {
    ...
    public void runtimeRegisterStat(Environmental E, String stat, String parms, boolean give) {
        ...
        else if ((E instanceof Physical) && CMStrings.contains(((Physical) E).basePhyStats().getStatCodes(), stat))
            oldVal = ((Physical) E).basePhyStats().getStat(stat);
        else if ((E instanceof MOB) && (CMStrings.contains(CharStats.CODES.NAMES(), stat)))
        ...
        while (text.length() > 0) {
            ...
            while (yy < text.length()) {
                if ((text.charAt(yy) == ';') && ((yy <= 0) || (text.charAt(yy - 1) != '\\'))) {
                    y = yy;
                    break;
                } else if (text.charAt(yy) == '\n') {
                    y = yy;
                    break;
                } else if (text.charAt(yy) == '\r') {
                    y = yy;
                    break;
                } else
                    yy++;
            ...
            if ((cmd.length() > 0) && (!cmd.startsWith("#"))) {
                if (cmd.toUpperCase().startsWith("<OPTION>")) {
                    V = new Vector();
                    script.addElement(V);
                } else if (cmd.toUpperCase().startsWith("</OPTION>"))
                    V = script;
                else
        ...
        while ((x >= 0) && (x < s.length() - 1)) {
            ...
            try {
                ...
                if ((possObjName != null) && (possObjName.length() > 0)) {
                    ...
                    else if (O instanceof TimeClock)
        ...
        switch (getCodeNum(code)) {
            ...
            default: {
                ...
                if (questState.isStat(code)) {
                    ...
                    if (O != null)
                        return O.toString();
                } else if (code.endsWith("_ROOMID") && (questState.isStat(code.substring(0, code.length() - 7)))) {
                ...
                } else if (code.endsWith("_CLASS") && (questState.isStat(code.substring(0, code.length() - 6)))) {
