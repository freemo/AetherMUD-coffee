...
public class DefaultScriptingEngine implements ScriptingEngine {
    ...
    public String getVar(final Resources resources, final String host, String var, String defaultVal) {
        ...
        if (H != null)
            val = (String) H.get(var.toUpperCase());
        else if ((defaultQuestName != null) && (defaultQuestName.length() > 0)) {
    ...
    protected Environmental findSomethingCalledThis(String thisName, MOB meMOB, Room imHere, List<Environmental> OBJS, boolean mob) {
        ...
        } else if (thisName.toUpperCase().trim().startsWith("FROMGENFILE ")) {
            try {
                List V = null;
    ...
    protected PhysicalAgent getArgumentItem(String str,
        ...
        if (str.charAt(0) == '$') {
            if (Character.isDigit(str.charAt(1))) {
                ...
                else if ((O instanceof List) && (str.length() > 3) && (str.charAt(2) == '.')) {
                    final List V = (List) O;
        ...
        while ((t >= 0) && (t < varifyable.length() - 1)) {
            ...
            if ((back.startsWith("."))
                ...
                if (back.equalsIgnoreCase(".LENGTH#")) {
                    ...
                    back = "";
                } else if ((back.length() > 1) && Character.isDigit(back.charAt(1))) {
                    int x = 1;
                    while ((x < back.length())
            ...
            switch (state) {
                case STATE_MAIN: {
                    if (Character.isWhitespace(evalC[c])) {
                        ...
                        if (s.length() > 0) {
                            ...
                            else if (!connH.containsKey(s))
                                throw new ScriptParseException("Unknown keyword: " + s);
                        }
                    } else if (Character.isLetter(evalC[c])
                        || (Character.isDigit(evalC[c]) && (c > 0) && Character.isLetter(evalC[c - 1]) && (c < evalC.length - 1) && Character.isLetter(evalC[c + 1]))) { /* move along */
                    } else {
                        switch (evalC[c]) {
                            case '!': {
                                if (c == evalC.length - 1)
                ...
                case STATE_MAYFUNCTION: {
                    if (evalC[c] == '(') {
                        ...
                        dex = c + 1;
                        state = STATE_INFUNCTION;
                    } else if (!Character.isWhitespace(evalC[c]))
                ...
                case STATE_POSTFUNCEVAL: {
                    ...
                    } else if (Character.isLetterOrDigit(evalC[c])) { /* move along */
                    } else if ((evalC[c] == '\'') || (evalC[c] == '`')) {
                        s = new String(evalC, dex, c - dex).trim();
                        if (s.length() == 0) {
                            lastQuote = evalC[c];
    ...
    public boolean eval(PhysicalAgent scripted,
        ...
        for (int t = startEval; t < tt.length; t++)
            ...
            } else if (connH.containsKey(tt[t])) {
            ...
            } else if (funcH.containsKey(tt[t])) {
                ...
                switch (funcCode.intValue()) {
                    ...
                    case 59: // isopen
                    {
                        ...
                        if (dir < 0) {
                            ...
                            else if ((E != null) && (E instanceof Exit))
                    ...
                    case 15: // isfollow
                    {
                        ...
                        if ((E == null) || (!(E instanceof MOB)))
                            returnable = false;
                        else if (((MOB) E).amFollowing() == null)
                            returnable = false;
                        else if (((MOB) E).amFollowing().location() != lastKnownLocation)
                            returnable = false;
                        else
                            returnable = true;
                        break;
                    ...
                    case 73: // isservant
                    {
                        ...
                        if ((E == null) || (!(E instanceof MOB)) || (lastKnownLocation == null))
                            returnable = false;
                        else if ((((MOB) E).getLiegeID() == null) || (((MOB) E).getLiegeID().length() == 0))
                            returnable = false;
                        else if (lastKnownLocation.fetchInhabitant("$" + ((MOB) E).getLiegeID() + "$") == null)
                            returnable = false;
                        else
                            returnable = true;
                        break;
                    ...
                    case 95: // isspeaking
                    {
                        ...
                        if ((E == null) || (!(E instanceof MOB)) || (lastKnownLocation == null))
                            ...
                            if ((L != null)
                                ...
                                returnable = true;
                            else if (arg2.equalsIgnoreCase("common") || arg2.equalsIgnoreCase("none"))
                                returnable = true;
                            else
                                returnable = false;
                        }
                    ...
                    case 55: // ispkill
                    {
                        ...
                        if ((E == null) || (!(E instanceof MOB)))
                            returnable = false;
                        else if (((MOB) E).isAttributeSet(MOB.Attrib.PLAYERKILL))
                            returnable = true;
                        else
                            returnable = false;
                        break;
                                ...
                                for (int m = 0; m < R.numInhabitants(); m++) {
                                    ...
                                    if (MASK != null) {
                                        if (CMLib.masking().maskCheck(MASK, M, true))
                                            num++;
                                    } else if (CMLib.english().containsString(M.name(), arg1))
                                        num++;
                                }
                            }
                        }
                                ...
                                if (!name.equalsIgnoreCase("*")) {
                                    ...
                                    for (int i = 0; i < lastKnownLocation.numInhabitants(); i++) {
                                        ...
                                        if (MASK != null) {
                                            if (CMLib.masking().maskCheck(MASK, M, true))
                                                num++;
                                        } else if (CMLib.english().containsString(M.Name(), name)
                                            || CMLib.english().containsString(M.displayText(), name))
                                            num++;
                                    }
                                }
                            }
                        } else if (!signH.containsKey(tt[t + 0])) {
                    ...
                    case 49: // hastattoo
                    {
                        ...
                        if (arg2.length() == 0) {
                            ...
                            break;
                        } else if ((E != null) && (E instanceof MOB))
                    ...
                    case 99: // hasacctattoo
                    {
                        ...
                        if (arg2.length() == 0) {
                            ...
                            break;
                        } else if ((E != null) && (E instanceof MOB) && (((MOB) E).playerStats() != null) && (((MOB) E).playerStats().getAccount() != null))
                    ...
                    case 37: // inlocale
                    {
                        ...
                        if (E == null)
                            ...
                            if (R == null)
                                returnable = false;
                            else if (CMClass.classID(R).toUpperCase().indexOf(arg2.toUpperCase()) >= 0)
                                returnable = true;
                            else
                                returnable = false;
                        }
                    ...
                    case 91: // datetime
                    {
                        ...
                        else if (CMLib.map().areaLocation(scripted) != null) {
                            String val = null;
                            switch (index) {
                                case 2:
                    ...
                    case 19: // position
                    {
                        ...
                        if (P == null)
                            ...
                            if (CMLib.flags().isSleeping(P))
                                sex = "SLEEPING";
                            else if (CMLib.flags().isSitting(P))
                                sex = "SITTING";
                            if (arg2.equals("=="))
                    ...
                    case 98: // clanqualifies
                    {
                        ...
                        if ((C != null) && (E instanceof MOB)) {
                            ...
                            if (C.isOnlyFamilyApplicants()
                                ...
                                returnable = false;
                            else if (CMLib.clans().getClansByCategory(mob, C.getCategory()).size() > CMProps.getMaxClansThisCategory(C.getCategory()))
                                returnable = false;
                            if (returnable && (!CMLib.masking().maskCheck(C.getBasicRequirementMask(), mob, true)))
                                returnable = false;
                            else if (returnable && (CMLib.masking().maskCheck(C.getAcceptanceSettings(), mob, true)))
                                returnable = false;
                        } else {
                    ...
                    case 65: // clan
                    {
                        ...
                        if ((E == null) || (!(E instanceof MOB)))
                            ...
                            if (arg2.equals("=="))
                                ...
                                returnable = !clanID.equalsIgnoreCase(arg3);
                            else if (arg2.equals("in"))
                                returnable = ((MOB) E).getClanRole(arg3) != null;
                            else if (arg2.equals("notin"))
                                returnable = ((MOB) E).getClanRole(arg3) == null;
                            else {
                                logError(scripted, "CLAN", "Syntax", funcParms);
                                return returnable;
        ...
        if ((y < 0) || (z < y)) {
            ...
            switch (funcCode.intValue()) {
                ...
                case 3: // worn
                {
                    ...
                    } else if ((E instanceof Item) && (!(((Item) E).amWearingAt(Wearable.IN_INVENTORY)))) {
                        if (E instanceof Container)
                            choices.addAll(((Container) E).getDeepContents());
                        else
                            choices.add((Item) E);
                ...
                case 72: // faction
                {
                    ...
                    if (F == null)
                        logError(scripted, "FACTION", "Unknown Faction", arg1);
                    else if ((E != null) && (E instanceof MOB) && (((MOB) E).hasFaction(F.factionID()))) {
                    ...
                    if (index < 0)
                        ...
                        switch (index) {
                            ...
                            case 5:
                                ...
                                break;
                            default:
                                results.append(CMLib.map().areaLocation(scripted).getTimeObj().getHourOfDay());
                                break;
                        }
                    }
                    break;
            ...
            switch (methCode.intValue()) {
                case 57: // <SCRIPT>
                {
                    ...
                    if (CMSecurity.isApprovedJScript(jscript)) {
                        ...
                        Context.exit();
                    } else if (CMProps.getIntVar(CMProps.Int.JSCRIPTS) == CMSecurity.JSCRIPT_REQ_APPROVAL) {
                        if (lastKnownLocation != null)
                ...
                case 19: // if
                {
                    ...
                    while (si < script.size()) {
                        ...
                        } else if (ignoreUntilEndScript) {
                        } else if (cmd.equals("ENDIF") && (depth == 0)) {
                            if (tt == null)
                                tt = parseBits(script, si, "C");
                            foundendif = true;
                            break;
                ...
                case 70: // switch
                {
                    ...
                    while (si < script.size()) {
                        ...
                        } else if (cmd.equals("ENDSWITCH") && (depth == 0)) {
                            if (tt == null)
                                tt = parseBits(script, si, "C");
                            foundendif = true;
                            break;
                        } else if (cmd.equals("CASE") && (depth == 0)) {
                            if (tt == null) {
                        ...
                        } else if (cmd.equals("DEFAULT") && (depth == 0)) {
                            inCase = !matchedCase;
                        } else {
                            if (inCase)
                                V.addElement(s, tt);
                ...
                case 62: // for x = 1 to 100
                {
                    ...
                    while (si < script.size()) {
                        ...
                        } else if (cmd.equals("NEXT") && (depth == 0)) {
                            if (tt == null)
                                tt = parseBits(script, si, "C");
                            foundnext = true;
                            break;
                    ...
                    if (V.size() > 1) {
                        ...
                        if (((increment > 0) && (fromInt <= (toInt + toAdd)))
                            ...
                            if (response == null)
                                response = execute(scripted, source, target, monster, primaryItem, secondaryItem, V, msg, tmp);
                            else if (response.equalsIgnoreCase("break"))
                                response = null;
                        }
                        if (response != null) {
                            tickStatus = Tickable.STATUS_END;
                ...
                case 73: // mpsetinternal
                {
                    ...
                    if (arg2.equals("SCOPE"))
                        setVarScope(arg3);
                    else if (arg2.equals("NODELAY"))
                        noDelay = CMath.s_bool(arg3);
                    else if (arg2.equals("ACTIVETRIGGER") || arg2.equals("ACTIVETRIGGERS"))
                        alwaysTriggers = CMath.s_bool(arg3);
                    else if (arg2.equals("DEFAULTQUEST"))
                        registerDefaultQuest(arg3);
                    else if (arg2.equals("SAVABLE"))
                        setSavable(CMath.s_bool(arg3));
                    else if (arg2.equals("PASSIVE"))
                ...
                case 35: // mpgset
                {
                    ...
                    if (newTarget != null) {
                        ...
                        } else if (newTarget instanceof Item) {
                ...
                case 59: // mpquestpoints
                {
                    ...
                    if (newTarget instanceof MOB) {
                        ...
                        } else if (val.startsWith("++") && (CMath.isNumber(val.substring(2).trim()))) {
                ...
                case 65: // MPQSET
                {
                    ...
                    else if (var.equalsIgnoreCase("QUESTOBJ")) {
                        if (obj == null)
                ...
                case 66: // MPLOG
                {
                    ...
                    else if (type.startsWith("I") || type.startsWith("S"))
                ...
                case 6: // mpoload
                {
                    ...
                    if (scripted instanceof MOB)
                        addHere = monster;
                    else if (scripted instanceof Item)
                        addHere = ((Item) scripted).owner();
                    else if (scripted instanceof Room)
                        addHere = scripted;
                    else
                            ...
                            for (int i = 0; i < Is.size(); i++) {
                                if (Is.get(i) instanceof Item) {
                                    ...
                                    if ((m != null)
                                        ...
                                        else if (addHere instanceof MOB)
                ...
                case 71: // mprejuv
                {
                    if (tt == null) {
                        ...
                        if (rest.equals("item") || rest.equals("items"))
                            tt = parseBits(script, si, "Ccr");
                        else if (rest.equals("mob") || rest.equals("mobs"))
                            tt = parseBits(script, si, "Ccr");
                        else
                            tt = parseBits(script, si, "Cr");
                        if (tt == null)
                    ...
                    else if (rest.equalsIgnoreCase("mob") || rest.equalsIgnoreCase("mobs"))
                        tickID = Tickable.TICKID_MOB;
                    if (next.equalsIgnoreCase("area")) {
                        if (lastKnownLocation != null)
                            for (final Enumeration<Room> e = lastKnownLocation.getArea().getProperMap(); e.hasMoreElements(); )
                                CMLib.threads().rejuv(e.nextElement(), tickID);
                    } else if (next.equalsIgnoreCase("room")) {
                        if (lastKnownLocation != null)
                ...
                case 44: // mpopen
                {
                    ...
                    if ((newTarget instanceof Exit) && (((Exit) newTarget).hasADoor())) {
                        ...
                        if (lastKnownLocation != null)
                            lastKnownLocation.recoverRoomStats();
                    } else if ((newTarget instanceof Container) && (((Container) newTarget).hasADoor())) {
                ...
                case 45: // mpclose
                {
                    ...
                    if ((newTarget instanceof Exit)
                        ...
                        if (lastKnownLocation != null)
                            lastKnownLocation.recoverRoomStats();
                    } else if ((newTarget instanceof Container)
                ...
                case 7: // mpechoat
                {
                    ...
                    } else if (parm.equalsIgnoreCase("world")) {
                    ...
                    } else if (parm.equalsIgnoreCase("area") && (lastKnownLocation != null)) {
                        lastKnownLocation.showSource(monster, null, CMMsg.MSG_OK_ACTION, varify(source, target, scripted, monster, primaryItem, secondaryItem, msg, tmp, tt[2]));
                        for (final Enumeration e = lastKnownLocation.getArea().getProperMap(); e.hasMoreElements(); ) {
                            final Room R = (Room) e.nextElement();
                            if (R.numInhabitants() > 0)
                    ...
                    } else if (CMLib.map().getRoom(parm) != null)
                    ...
                    else if (CMLib.map().findArea(parm) != null) {
                        lastKnownLocation.showSource(monster, null, CMMsg.MSG_OK_ACTION, varify(source, target, scripted, monster, primaryItem, secondaryItem, msg, tmp, tt[2]));
                ...
                case 72: // mpscript
                {
                    ...
                    while (proceed) {
                        ...
                        if (m2.toUpperCase().startsWith("SAVABLE")) {
                            ...
                            proceed = true;
                        } else if (m2.toUpperCase().startsWith("EXECUTE")) {
                            execute = true;
                            m2 = m2.substring(8).trim();
                            proceed = true;
                        } else if (m2.toUpperCase().startsWith("GLOBAL")) {
                            scope = "";
                            proceed = true;
                            m2 = m2.substring(6).trim();
                        } else if (m2.toUpperCase().startsWith("INDIVIDUAL") || m2.equals("*")) {
                            scope = "*";
                            proceed = true;
                ...
                case 55: // mpnotrigger
                {
                    ...
                    else if (!CMath.isInteger(time.trim()))
                ...
                case 12: // mppurge
                {
                    if (lastKnownLocation != null) {
                        ...
                        if (s2.equalsIgnoreCase("room")) {
                            flag = 1;
                            s2 = tt[2];
                        } else if (s2.equalsIgnoreCase("my")) {
                            flag = 2;
                            s2 = tt[2];
                        }
                        Environmental E = null;
                        ...
                        if (E != null) {
                            if (E instanceof MOB) {
                                ...
                                } else if (((MOB) E).getStartRoom() != null)
                    ...
                    if (roomName.length() > 0) {
                        ...
                        if (newRoom != null) {
                            ...
                            for (int v = 0; v < V.size(); v++) {
                                ...
                                } else if ((V.get(v) instanceof Item)
                ...
                case 79: // mppossess
                {
                    ...
                    else if ((!(newTarget instanceof MOB)) || (!((MOB) newTarget).isMonster()) || CMSecurity.isASysOp((MOB) newTarget))
                ...
                case 40: // MPM2I2M
                {
                    ...
                    } else if (E instanceof CagedAnimal) {
                            ...
                            if (min > 0) {
                                ...
                                if (E.subjectToWearAndTear()) {
                                    ...
                                    if (E.usesRemaining() <= 0)
                                        destroy = true;
                                } else if (arg4.equalsIgnoreCase("kill"))
                                    destroy = true;
                                if (destroy) {
                                    if (lastKnownLocation != null)
                ...
                case 21: //MPENDQUEST
                {
                    ...
                    if (Q != null)
                        Q.stopQuest();
                    else if ((tt[1].length() > 0) && (defaultQuestName != null) && (defaultQuestName.length() > 0)) {
                    ...
                    if (tt == null) {
                        ...
                        for (int i = 0; i < conditionStr.length(); i++) {
                            if (conditionStr.charAt(i) == '(')
                                depth++;
                            else if ((conditionStr.charAt(i) == ')') && ((--depth) < 0)) {
                                x = i;
                                break;
                            }
                        }
                ...
                case 37: // mpenable
                {
                    ...
                    if (cast != null) {
                        ...
                        if (A == null) {
                            ...
                            else if ((newTarget != null) && (newTarget instanceof MOB))
                            ...
                            if (t != null) {
                                ...
                                if (chk) {
                                    ...
                                    if ((t[2].length() == 0) || (t[2].equals("ALL")))
                                        tryIt = true;
                                    else if ((t[2].equals("P")) && (t.length > 3)) {
                    ...
                    case 3: // speech_prog
                        if (((msg.sourceMinor() == CMMsg.TYP_SPEAK) || (msg.targetMinor() == CMMsg.TYP_SPEAK)) && canTrigger(3)
                            ...
                            if (t != null) {
                                ...
                                else if (msg.targetMessage() != null)
                                ...
                                if (str != null) {
                                    ...
                                    if ((t[1].length() == 0) || (t[1].equals("ALL"))) {
                                        ...
                                        return;
                                    } else if ((t[1].equals("P")) && (t.length > 2)) {
                        ...
                        if (!msg.amISource(monster)
                            ...
                            if (t != null) {
                                ...
                                if (channel.equalsIgnoreCase(CMLib.channels().getChannel(channelInt).name())) {
                                    ...
                                    if ((t[2].length() == 0) || (t[2].equals("ALL")))
                                        doIt = true;
                                    else if (t[2].equals("P") && (t.length > 2)) {
                                        if (match(str.trim(), t[3]))
                                            doIt = true;
                                    } else
                                        for (int i = 2; i < t.length; i++) {
