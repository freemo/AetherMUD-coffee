        ...
        if (!tryArchon) {
            ...
            for (Item I : baseItems) {
                if ((I instanceof AmmunitionWeapon) && ((AmmunitionWeapon) I).requiresAmmunition()) {
                    ...
                    else if (((AmmunitionWeapon) I).isFreeStanding())
                        items.add((AmmunitionWeapon) I);
                }
            }
            if (baseItems.size() == 0)
            ...
            if ((commands.get(1).equalsIgnoreCase("AREA"))
                ...
                return false;
            } else if ((what.equalsIgnoreCase("CLASS") || (CMClass.findObjectType(what) != null))
                ...
                if (whatType == null)
                    ...
                    for (int i = 0; i < commands.size(); i++) {
                        ...
                        else if (!CMClass.delClass(whatType, (CMObject) O))
            ...
            } else if (str.equalsIgnoreCase("inifile")) {
                ...
                if ((commands.get(1).equalsIgnoreCase("USER"))
                    ...
                    if ((commands.get(1).equalsIgnoreCase("FACTION"))
                    ...
                    } else if (("EXPERTISE".startsWith(commands.get(1).toUpperCase()))
                        ...
                        return false;
                    } else if (commands.get(1).equalsIgnoreCase("RESOURCE")) {
                        final String which = CMParms.combine(commands, 2);
                    ...
                    } else if (commands.get(1).equalsIgnoreCase("FILE")) {
                        final String which = CMParms.combine(commands, 2);
