    ...
    public boolean execute(MOB mob, List<String> commands, int metaFlags)
        ...
        if (CMSecurity.isAllowed(mob, mob.location(), CMSecurity.SecFlag.STAT)) {
            ...
            if (s1.equalsIgnoreCase("TODAY"))
                ...
                else if (s2.equals("DAYS") && (CMath.isNumber(s1)))
                    return showTableStats(mob, (CMath.s_int(s1)), 1, rest);
                else if (s2.equals("WEEK") && (CMath.isNumber(s1)))
                    return showTableStats(mob, (CMath.s_int(s1) * 7), 7, rest);
                else if (s2.equals("WEEKS") && (CMath.isNumber(s1)))
                    return showTableStats(mob, (CMath.s_int(s1) * 7), 7, rest);
                else if (s2.equals("MONTH") && (CMath.isNumber(s1)))
                    return showTableStats(mob, (CMath.s_int(s1) * 30), 30, rest);
                else if (s2.equals("MONTHS") && (CMath.isNumber(s1)))
                    return showTableStats(mob, (CMath.s_int(s1) * 30), 30, rest);
                else if (s2.equals("YEAR") && (CMath.isNumber(s1)))
                    return showTableStats(mob, (CMath.s_int(s1) * 365), 365, rest);
                else if (s2.equals("YEARS") && (CMath.isNumber(s1)))
                    return showTableStats(mob, (CMath.s_int(s1) * 365), 365, rest);
            }
            ...
            if ((target != null)
                ...
                if (ableTypes >= 0) {
                ...
                } else if (ableTypes == ABLETYPE_EQUIPMENT)
                    str = CMLib.commands().getEquipment(mob, target);
                else if (ableTypes == ABLETYPE_INVENTORY)
                    str = CMLib.commands().getInventory(mob, target);
                else if (ableTypes == ABLETYPE_QUESTWINS) {
                    ...
                    str.append(won);
                    str.append("\n\r");
                } else if (ableTypes == ABLETYPE_TITLES) {
                    str.append(L("Titles:"));
                    ...
                    str.append(ttl);
                    str.append("\n\r");
                } else if (ableTypes == ABLETYPE_SCRIPTS) {
                    ...
                    str.append("\n\r");
                } else if (ableTypes == ABLETYPE_TATTOOS) {
                    ...
                    str.append("\n\r");
                } else if (ableTypes == ABLETYPE_FACTIONS) {
                    ...
                    str.append("\n\r");
                } else if (ableTypes == ABLETYPE_LEVELTIMES) {
                    if (target.playerStats() != null) {
                        long lastDateTime = -1;
                    ...
                    str.append("\n\r");
                } else if (ableTypes == ABLETYPE_CHARSTATS) {
                    ...
                    str.append("\n\r");
                } else if (ableTypes == ABLETYPE_WORLDEXPLORED) {
                    if (target.playerStats() != null)
                ...
                } else if (ableTypes == ABLETYPE_AREASEXPLORED) {
                    if (target.playerStats() != null) {
                        ...
                        str.append(L("Exploration data is not kept on mobs.\n\r"));
                } else if (ableTypes == ABLETYPE_ROOMSEXPLORED) {
                    if (target.playerStats() != null) {
                        ...
                        str.append(L("Exploration data is not kept on mobs.\n\r"));
                } else if (ableTypes == ABLETYPE_COMBAT) {
        ...
        if ((commands.size() > 0) && (str.length() == 0)) {
            ...
            if (CMSecurity.isAllowed(mob, mob.location(), CMSecurity.SecFlag.STAT)) {
                ...
                if (MOBname.equalsIgnoreCase("ROOM")) {
                    ...
                    return true;
                } else if (MOBname.equalsIgnoreCase("AREA")) {
                    ...
                    return false;
                } else if (firstWord.equalsIgnoreCase("ITEM")) {
                    ...
                    return false;
                } else if (firstWord.equalsIgnoreCase("ROOM")) {
                ...
                } else if (firstWord.equalsIgnoreCase("AREA")) {
            ...
            for (int i = 0; i < commands.size(); i++) {
                ...
                if (thisStat.equals("XP")) {
                    ...
                    found = true;
                } else if (thisStat.equals("ATTRIBUTES")) {
                    ...
                    found = true;
                } else if (thisStat.equals("RESISTS")) {
                    CharStats CT = mob.charStats();
                    for (final int stat : CharStats.CODES.SAVING_THROWS())
                        str.append(CMStrings.capitalizeAndLower(CharStats.CODES.NAME(stat)) + "(" + CT.getStat(stat)).append(") ");
                    found = true;
                } else if (thisStat.equals("HEALTH")) {
                ...
                if (!found) {
                    for (String stat : M.phyStats().getStatCodes()) {
                        if (stat.equals(thisStat)) {
                            ...
                            else if (stat.equals("DISPOSITION"))
