...
import com.syncleus.aethermud.game.Libraries.interfaces.ColorLibrary.Color;
...
import com.syncleus.aethermud.game.core.collections.Quad;
import com.syncleus.aethermud.game.core.collections.RTree;
...
public class Test extends StdCommand {
    ...
    public boolean execute(MOB mob, List<String> commands, int metaFlags)
        ...
        if (commands.size() > 1) {
            ...
            if (what.equalsIgnoreCase("levelxptest")) {
            ...
            } else if (what.equalsIgnoreCase("levelcharts")) {
                final StringBuffer str = new StringBuffer("");
                for (int i = 0; i < 110; i++)
                    str.append(i + "=" + CMLib.leveler().getLevelExperience(i) + "\r");
                mob.tell(str.toString());
            } else if (what.equalsIgnoreCase("ratspercolator")) {
            ...
            } else if (what.equalsIgnoreCase("timsdeconstruction")) {
                mob.tell(L("Checking..."));
                final String theRest = CMParms.combine(commands, 2).toUpperCase();
            ...
            } else if (what.equalsIgnoreCase("recover")) {
            ...
            } else if (what.equalsIgnoreCase("deconstruction")) {
            ...
            } else if (what.equalsIgnoreCase("statcreationspeed")) {
            ...
            } else if (what.equalsIgnoreCase("randomroompick")) {
            ...
            } else if (what.equalsIgnoreCase("randomnames")) {
                final int num = CMath.s_int(CMParms.combine(commands, 2));
            ...
            } else if (what.equalsIgnoreCase("edrecipe")) {
            ...
            } else if (what.equalsIgnoreCase("scriptable")) {
            ...
            } else if (what.equalsIgnoreCase("mudhourstil")) {
                ...
                return true;
            } else if (what.equalsIgnoreCase("horsedraggers")) {
