...
public class Export extends StdCommand {
    ...
    public boolean execute(MOB mob, List<String> commands, int metaFlags)
        ...
        } else if (!CMSecurity.isAllowed(mob, room, CMSecurity.SecFlag.EXPORT)) {
            if (S != null)
        ...
        if (commands.size() > 0) {
            ...
            if ((sub.equalsIgnoreCase("ITEMS")
                ...
                subType = sub;
                commands.remove(0);
            } else if (sub.equalsIgnoreCase("data"))
                commands.remove(0);
            else if ((commandType.equalsIgnoreCase("PLAYER"))
                && (CMLib.players().getLoadPlayer(sub) != null)) {
                subType = sub;
                commands.remove(0);
            } else if ((commandType.equalsIgnoreCase("ACCOUNT"))
            ...
            if (fileName.equalsIgnoreCase("screen"))
                ...
                fileNameCode = 3;
            else if (fileName.equalsIgnoreCase("memory")) {
    ...
    public Object executeInternal(MOB mob, int metaFlags, Object... args) throws java.io.IOException {
        ...
        if (subType.equalsIgnoreCase("DATA")) {
            if (commandType.equalsIgnoreCase("PLAYER")) {
                ...
                if (S != null)
                    S.rawPrintln("!");
            } else if (commandType.equalsIgnoreCase("CATALOG")) {
            ...
            if (((type != null) && (type != CMObjectType.ITEM)) || (subType.equalsIgnoreCase("ITEMS")))
                x.append(" HASITEMS>");
            else if (subType.equalsIgnoreCase("MOBS"))
                x.append(" HASMOBS>");
            else
                x.append(" HASBOTH>");
            if ((((type == null) || (type == CMObjectType.ITEM))) && (!subType.equalsIgnoreCase("ITEMS"))) {
        ...
        } else if ((subType.equalsIgnoreCase("ITEMS"))
