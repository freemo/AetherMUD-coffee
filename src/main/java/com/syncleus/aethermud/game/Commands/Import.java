...
public class Import extends StdCommand {
    ...
    protected static String getAreaName(List<String> V) {
        ...
        if (areaName.toUpperCase().startsWith("NAME ")) {
            ...
            else if ((areaName.length() > 13) && ((areaName.charAt(12) == '{') || (areaName.charAt(13) == '{'))) {
    ...
    protected static Room getRoom(java.util.Map<String, Room> hashedRoomSet, String areaName, String calledThis) {
        ...
        } else if (calledThis.startsWith(areaName + "#")) {
    ...
    protected static String getAreaAuthor(List<String> V) {
        ...
        for (int v = 0; v < V.size(); v++) {
            ...
            if (s.toUpperCase().startsWith("#AUTHOR ")) {
                ...
                return s;
            } else if (s.toUpperCase().startsWith("BUILDERS ")) {
                ...
                if ((s.length() == 0) || (s.toUpperCase().equalsIgnoreCase("NONE")))
                    continue;
                return s;
            } else if ((s.toUpperCase().startsWith("#AREA "))
                && (s.indexOf('{') > 0)) {
            ...
            } else if (s.trim().startsWith("O ") && (s.trim().endsWith("~"))) {
                ...
                if ((s.length() == 0) || (s.toUpperCase().equalsIgnoreCase("NONE")))
                    continue;
                return s;
            } else if (s.toUpperCase().startsWith("CREDITS ")) {
                s = s.substring(8).trim();
                if (s.trim().startsWith("("))
                    continue;
                if (s.trim().startsWith("{")) {
                    ...
                    if (x > 0)
                        s = s.substring(x + 1).trim();
                } else if ((CMParms.parse(s).size() > 2)
        ...
        if ((x < 0) && (s.length() > 0) && (CMath.s_int(s) == 0)) {
            ...
            for (int z = 0; z < s.length(); z++)
                if (!Character.isLetter(s.charAt(z))) {
                    otherStyle = false;
                    break;
                } else if (Character.isUpperCase(s.charAt(z)))
                    num = num | (1 << (s.charAt(z)) - ('A'));
                else if (Character.isLowerCase(s.charAt(z)))
    ...
    protected static String getSpell(String word, int i) {
        if ((word.trim().length() > 0) && ((Character.isLetter(word.trim().charAt(0))) || (word.trim().startsWith("'")) || (word.trim().startsWith("`")))) {
            ...
            if (word.startsWith("NONE"))
                i = -1;
            else if (word.startsWith("COMPLETE HEAL"))
                i = 209;
            else if (word.startsWith("RESTORE MANA"))
                i = 234;
            else if (word.startsWith("ACID B"))
                i = 70;
            else if (word.startsWith("ARMOR"))
                i = 1;
            else if (word.startsWith("ENHANCED ARMOR"))
                i = 212;
            else if (word.startsWith("ENHANCE ARMOR"))
                i = 212;
            else if (word.startsWith("BLESS"))
                i = 3;
            else if (word.startsWith("BLINDNE"))
                i = 4;
            else if (word.startsWith("BURNING H"))
                i = 5;
            else if (word.startsWith("HASTE"))
                i = 84;
            else if (word.startsWith("CALL LIGH"))
                i = 6;
            else if (word.startsWith("GENERAL PURPOSE"))
                i = -1;
            else if (word.startsWith("CANCELLA"))
                i = 59;
            else if (word.startsWith("CAUSE CRI"))
                i = 63;
            else if (word.startsWith("CAUSE LI"))
                i = 62;
            else if (word.startsWith("CAUSE SE"))
                i = 222;
            else if (word.startsWith("CHANGE SE"))
                i = 82;
            else if (word.startsWith("CHARM PER"))
                i = 7;
            else if (word.startsWith("CHILL TOU"))
                i = 8;
            else if (word.startsWith("COLO"))
                i = 10;
            else if (word.startsWith("RESERVED"))
                i = 223;
            else if (word.startsWith("FIREBA"))
                i = 26;
            else if (word.startsWith("FLAMESTR"))
                i = 65;
            else if (word.startsWith("FLY"))
                i = 56;
            else if (word.startsWith("GATE"))
                i = 83;
            else if (word.startsWith("GIANT"))
                i = 39;
            else if (word.startsWith("HOLY STRE"))
                i = 39;
            else if (word.startsWith("ENHANCED STRE"))
                i = 39;
            else if (word.startsWith("HARM"))
                i = 27;
            else if (word.startsWith("HOLY FIRE"))
                i = 27;
            else if (word.startsWith("HEAL"))
                i = 28;
            else if (word.startsWith("IDENTIFY"))
                i = 53;
            else if (word.startsWith("INFRAVISION"))
                i = 77;
            else if (word.startsWith("INVIS"))
                i = 29;
            else if (word.startsWith("KNOW"))
                i = 58;
            else if (word.startsWith("LIGHTNING BOLT"))
                i = 30;
            else if (word.startsWith("LIGHTENING BOLT"))
                i = 30;
            else if (word.startsWith("LIGHTNINGBOLT"))
                i = 30;
            else if (word.startsWith("LIGHTENINGBOLT"))
                i = 30;
            else if (word.startsWith("LOCATE"))
                i = 31;
            else if (word.startsWith("CANCELL"))
                i = 57;
            else if (word.startsWith("CONTINU"))
                i = 57;
            else if (word.startsWith("CONTROL"))
                i = 11;
            else if (word.startsWith("CREATE FO"))
                i = 12;
            else if (word.startsWith("CREATE SP"))
                i = 80;
            else if (word.startsWith("CREATE WA"))
                i = 13;
            else if (word.startsWith("CURE BLI"))
                i = 14;
            else if (word.startsWith("CURE CRI"))
                i = 15;
            else if (word.startsWith("CURE LI"))
                i = 16;
            else if (word.startsWith("CURE PO"))
                i = 43;
            else if (word.startsWith("CURE SE"))
                i = 61;
            else if (word.startsWith("CURE D"))
                i = 45;
            else if (word.startsWith("DETECT E"))
                i = 18;
            else if (word.startsWith("DETECT HI"))
                i = 44;
            else if (word.startsWith("DETECT I"))
                i = 19;
            else if (word.startsWith("DETECT M"))
                i = 20;
            else if (word.startsWith("DETECT P"))
                i = 21;
            else if (word.startsWith("DISPEL E"))
                i = 22;
            else if (word.startsWith("DISPEL M"))
                i = 59;
            else if (word.startsWith("EARTHQ"))
                i = 23;
            else if (word.startsWith("ENCHANT W"))
                i = 24;
            else if (word.startsWith("ENERGY DRA"))
                i = 25;
            else if (word.startsWith("FAERIE F"))
                i = 72;
            else if (word.startsWith("MAGIC MI"))
                i = 32;
            else if (word.startsWith("MASS INV"))
                i = 69;
            else if (word.startsWith("PASS D"))
                i = 74;
            else if (word.startsWith("POISON"))
                i = 33;
            else if (word.startsWith("PROTECTION"))
                i = 34;
            else if (word.startsWith("REFRESH"))
                i = 81;
            else if (word.startsWith("REMOVE CU"))
                i = 35;
            else if (word.startsWith("SANCTUARY"))
                i = 36;
            else if (word.startsWith("SHIELD"))
                i = 67;
            else if (word.startsWith("SHOCKING G"))
                i = 37;
            else if (word.startsWith("SLEEP"))
                i = 38;
            else if (word.startsWith("STONE SK"))
                i = 66;
            else if (word.startsWith("SUMMON"))
                i = 40;
            else if (word.startsWith("TELEPORT"))
                i = 2;
            else if (word.startsWith("VENTRI"))
                i = 41;
            else if (word.startsWith("WEAKEN"))
                i = 68;
            else if (word.startsWith("WORD OF R"))
                i = 42;
            else if (word.startsWith("ACID BR"))
                i = 200;
            else if (word.startsWith("FIRE BR"))
                i = 201;
            else if (word.startsWith("FROST BR"))
                i = 202;
            else if (word.startsWith("GAS BR"))
                i = 203;
            else if (word.startsWith("LIGHTNING BR"))
                i = 204;
            else if (word.startsWith("LIGHTENING BR"))
                i = 204;
            else if (word.startsWith("FRENZY"))
                i = 205;
            else if (word.startsWith("DISPEL G"))
                i = 206;
            else if (word.startsWith("CURSE"))
                i = 17;
            else if (word.startsWith("ENCHANT W"))
                i = 207;
            else if (word.startsWith("ENCHANT A"))
                i = 208;
            else if (word.startsWith("REJUV"))
                i = 209;
            else if (word.startsWith("PLAGUE"))
                i = 213;
            else if (word.startsWith("HEAT M"))
                i = 210;
            else if (word.startsWith("HIGH EXP"))
                i = 26;
            else if (word.startsWith("FARSIGHT"))
                i = 211;
            else if (word.startsWith("SLOW"))
                i = 214;
            else if (word.startsWith("WEB"))
                i = 215;
            else if (word.startsWith("CONFUSE"))
                i = 216;
            else if (word.startsWith("FIRESHIELD"))
                i = 232;
            else if (word.startsWith("ICESHIELD"))
                i = 232;
            else if (word.startsWith("SHOCKSHIELD"))
                i = 89;
            else if (word.startsWith("BLADE BARRIER"))
                i = 233;
            else if (word.startsWith("SENSE LI"))
                i = 217;
            else if (word.startsWith("MYSTERIOUS DR"))
                i = 218;
            else if (word.startsWith("MIND LIGHT"))
                i = 219;
            else if (word.startsWith("ACUTE VIS"))
                i = 44;
            else if (word.startsWith("CALM"))
                i = 220;
            else if (word.startsWith("DETECT G"))
                i = 221;
            else if (word.startsWith("DEMONFIRE"))
                i = 27;
            else if (word.startsWith("BARK SKIN"))
                i = 224;
            else if (word.startsWith("STEEL SKIN"))
                i = 224;
            else if (word.startsWith("LETHARGIC MIS"))
                i = 214;
            else if (word.startsWith("BLACK DEATH"))
                i = 213;
            else if (word.startsWith("DISGRACE"))
                i = 225;
            else if (word.startsWith("POWER WORD ST"))
                i = 226;
            else if (word.startsWith("MASTER HEAL"))
                i = 227;
            else if (word.startsWith("SCREAM"))
                i = 32;
            else if (word.startsWith("SEVERITY FO"))
                i = 23;
            else if (word.startsWith("HOLY WORD"))
                i = 228;
            else if (word.startsWith("MASS HEAL"))
                i = 229;
            else if (word.startsWith("ACID RAIN"))
                i = 230;
            else if (word.startsWith("ETHEREAL FORM"))
                i = 231;
            else if (word.startsWith("MANA"))
                i = 234;
            else if (word.startsWith("CHAOS FIELD"))
                i = 235;
            else if (word.startsWith("COMBAT MIND"))
                i = 236;
            else if (word.startsWith("DARK BLESSING"))
                i = 17;
            else if (word.startsWith("FLESH ARMOR"))
                i = 224;
            else if (word.startsWith("TRUE SIGHT"))
                i = 237;
            else if (word.startsWith("INERTIAL"))
                i = 36;
            else if (word.startsWith("PHASE SHIFT"))
                i = 36;
            else if (word.startsWith("DISPLACEMENT"))
                i = 244;
            else if (word.startsWith("THOUGHT SHIELD"))
                i = 238;
            else if (word.startsWith("INTELLECT FORTRESS"))
                i = 238;
            else if (word.startsWith("MENTAL BARRIER"))
                i = 238;
            else if (word.startsWith("MENTAL BLOCK"))
                i = 238;
            else if (word.startsWith("SHATTER"))
                i = 239;
            else if (word.startsWith("ICESTORM"))
                i = 240;
            else if (word.startsWith("DISINTEGRATE"))
                i = 241;
            else if (word.startsWith("ANIMATE DEAD"))
                i = 242;
            else if (word.startsWith("VIBRATE"))
                i = 243;
            else if (word.startsWith("ULTRABLAST"))
                i = 26;
            else if (word.startsWith("FIELD OF DECAY"))
                i = 245;
            else if (word.startsWith("BIOFEEDBACK"))
                i = 245;
            else if (word.startsWith("DANCING LIGHTS"))
                i = 246;
            else if (word.startsWith("BIO-ACCELERATION"))
                i = 227;
            else if (word.startsWith("CELL ADJUSTMENT"))
                i = 227;
            else if (word.startsWith("AURA SIGHT"))
                i = 20;
            else if (word.startsWith("ENERGY CONTAINMENT"))
                i = 247;
            else {
    ...
    protected static void readBlocks(
        ...
        while (buf.size() > 0) {
            ...
            if (s.startsWith("#")) {
                ...
                } else if (s.startsWith("MOBPROG")) {
                    wasUsingThisOne = null;
                    useThisOne = mobProgData;
                } else if (s.startsWith("ROOMPROG")) {
                    wasUsingThisOne = null;
                    useThisOne = roomProgData;
                } else if (s.startsWith("ROOM")) {
                    wasUsingThisOne = roomData;
                    useThisOne = new Vector<String>();
                } else if (s.startsWith("RESETS")) {
                    wasUsingThisOne = null;
                    useThisOne = resetData;
                } else if (s.startsWith("SHOP")) {
                    wasUsingThisOne = null;
                    useThisOne = shopData;
                } else if (s.startsWith("SPECIALS")) {
                    wasUsingThisOne = null;
                    useThisOne = specialData;
                } else if (s.startsWith("SOCIALS")) {
                    wasUsingThisOne = null;
                    useThisOne = socialData;
                } else if (((importNumber(s) > 0) || (s.equals("0") && (buf.size() > 1) && (buf.get(1).indexOf('~') > 0)))
                    && (wasUsingThisOne != null)) {
                    final List<String> V = new Vector<String>();
                    wasUsingThisOne.add(V);
                    useThisOne = V;
                } else if (s.equals("0") || s.equals("$") || s.equals("O"))
                    okString = false;
                else if ((s.equals("") || s.equals("~")) && (useThisOne == socialData))
                    okString = true;
                else if ((useThisOne == mobProgData) || (useThisOne == roomProgData))
                    okString = true;
                else {
                    //useThisOne=null;
    ...
    protected static void doWeapon(Weapon I, String name, int val1, String str1, int val2, int val3, int val4, String str4) {
        ...
        if ((str4.trim().length() > 0) && ((Character.isLetter(str4.trim().charAt(0))) || (str4.trim().startsWith("'")))) {
            ...
            if (str4.startsWith("POUND"))
                val4 = 7;
            else if (str4.startsWith("CRUSH"))
                val4 = 7;
            else if (str4.startsWith("SMASH"))
                val4 = 7;
            else if (str4.startsWith("FLAMI"))
                val4 = 57;
            else if (str4.startsWith("SCORC"))
                val4 = 57;
            else if (str4.startsWith("SEARI"))
                val4 = 57;
            else if (str4.startsWith("GOUT"))
                val4 = 57;
            else if (str4.startsWith("SCRATCH"))
                val4 = 22;
            else if (str4.startsWith("CLAW"))
                val4 = 22;
            else if (str4.startsWith("BITE"))
                val4 = 22;
            else if (str4.startsWith("PECK"))
                val4 = 22;
            else if (str4.startsWith("STING"))
                val4 = 22;
            else if (str4.startsWith("BEAT"))
                val4 = 22;
            else if (str4.startsWith("SLAP"))
                val4 = 22;
            else if (str4.startsWith("PUNC"))
                val4 = 22;
            else if (str4.startsWith("WHALL"))
                val4 = 22;
            else if (str4.startsWith("STAB"))
                val4 = 2;
            else if (str4.startsWith("PIERCE"))
                val4 = 2;
            else if (str4.startsWith("CHOP"))
                val4 = 25;
            else if (str4.startsWith("CLEA"))
                val4 = 25;
            else if (str4.startsWith("SLIC"))
                val4 = 25;
            else if (str4.startsWith("SLAS"))
                val4 = 25;
            else if (str4.startsWith("WHIP"))
                val4 = 25;
        }
        switch (val4) {
            case 7:
    ...
    protected static MOB getMOB(String OfThisID,
        ...
        for (int m = 0; m < mobData.size(); m++) {
            ...
            else if (mobData.get(m) instanceof String) {
            ...
            else if (simpleName.toUpperCase().indexOf("HORSE") >= 0)
            ...
            for (int i = 0; i < shopData.size(); i++) {
                ...
                if (("#" + s).startsWith(OfThisID + " ") || ("#" + s).startsWith(OfThisID + "\t") || ("#" + s).startsWith(OfThisID + "	")) {
                    ...
                    else if ((((i1 > 1) && (i1 < 5)) || (i1 == 10) || (i1 == 26))
                        && (((i2 > 1) && (i2 < 5)) || (i2 == 10) || (i2 == 26))
                        && (((i3 > 1) && (i3 < 5)) || (i3 == 10) || (i3 == 26)))
                        whatIsell = ShopKeeper.DEAL_MAGIC;
                    else if (((i1 == 9) || (i1 == 0)) && ((i2 == 9) || (i2 == 0)) && ((i3 == 9) || (i3 == 0)))
                        whatIsell = ShopKeeper.DEAL_ARMOR;
                    else if (mobName.toUpperCase().indexOf("LEATHER") >= 0)
                        whatIsell = ShopKeeper.DEAL_LEATHER;
                    else if ((mobName.toUpperCase().indexOf("PET ") >= 0) || (mobName.toUpperCase().indexOf("PETS ") >= 0))
            ...
            if (CMParms.numBits(codeStr2) >= 4) {
                ...
                if (circleFormat) {
                    ...
                    else if (CMParms.getCleanBit(codeStr4, 2).trim().toUpperCase().equals("MALE"))
                        sexCode = 1;
                    else if (CMParms.getCleanBit(codeStr4, 2).trim().toUpperCase().equals("FEMALE"))
                        sexCode = 2;
                    else if (CMParms.getCleanBit(codeStr4, 2).trim().toUpperCase().equals("EITHER"))
                    ...
                    else if (CMParms.getCleanBit(codeStr4, 0).trim().startsWith("STAND"))
                        positionCode = 8;
                    else if (CMParms.getCleanBit(codeStr4, 0).trim().startsWith("SIT"))
                        positionCode = 5;
                    else if (CMParms.getCleanBit(codeStr4, 0).trim().startsWith("SLEEP"))
                        positionCode = 1;
            ...
            for (int mp = 0; mp < mobProgData.size(); mp++) {
                ...
                if (s.startsWith("M ")) {
                    ...
                    if (mobprg.equals("JANITOR.PRG"))
                        M.addBehavior(CMClass.getBehavior("Scavenger"));
                    else if (mobprg.equals("VAGABOND.PRG"))
                        M.addBehavior(CMClass.getBehavior("Vagrant"));
                    else if (mobprg.equals("DRUNK.PRG")) {
                        if (M.fetchEffect("Inebriation") == null)
                            M.addNonUninvokableEffect(CMClass.getAbility("Inebriation"));
                    } else if (mobprg.equals("MID_CIT.PRG")) {
                        //
                    } else if (mobprg.equals("BEGGAR.PRG"))
                        M.addBehavior(CMClass.getBehavior("Beggar"));
                    else if (mobprg.equals("GATEGRD.PRG"))
                        M.addBehavior(CMClass.getBehavior("GateGuard"));
                    else if (mobprg.equals("GATEGRD2.PRG"))
                        M.addBehavior(CMClass.getBehavior("GateGuard"));
                    else if (mobprg.equals("CRIER.PRG")) {
                    } else if (rest != null)
                        continue;
                    else {
                        try {
                    ...
                    // also unsupported
                } else if ((s.startsWith("#M")) || (s.startsWith("S"))) {
            ...
            for (int mp = 0; mp < specialData.size(); mp++) {
                ...
                if (s.startsWith("M ")) {
                    ...
                    if ((special.equals("SPEC_CAST_MAGE"))
                        ...
                        M.addBehavior(CMClass.getBehavior("Mageness"));
                    else if (special.equals("SPEC_CAST_SENESCHAL")) {
                        M.addBehavior(CMClass.getBehavior("CombatAbilities"));
                    ...
                    } else if (special.equals("SPEC_CAST_BEHOLDER")) {
                        M.addBehavior(CMClass.getBehavior("CombatAbilities"));
                    ...
                    } else if (special.equals("SPEC_CAST_PSIONICIST")) {
                        M.addBehavior(CMClass.getBehavior("CombatAbilities"));
                        M.addAbility(CMClass.getAbility("Spell_Spook"));
                        M.addAbility(CMClass.getAbility("Spell_Slow"));
                        M.addAbility(CMClass.getAbility("Spell_DispelMagic"));
                    ...
                    } else if ((special.equals("SPEC_CAST_GHOST"))
                        ...
                        M.addAbility(CMClass.getAbility("WeakParalysis"));
                    } else if (special.equals("SPEC_THIEF"))
                        M.addBehavior(CMClass.getBehavior("Thiefness"));
                    else if (special.equals("SPEC_SNAKE_CHARM")) {
                        // ends combat, and makes people give him their weapons
                        Log.errOut("IMPORT", "Unsupported spec: " + special);
                    } else if (special.equals("SPEC_KUNGFU_POISON")) {
                        Log.errOut("IMPORT", "Unsupported spec: " + special);
                    } else if (special.equals("SPEC_TAXIDERMIST")) {
                        Log.errOut("IMPORT", "Unsupported spec: " + special);
                    } else if (special.equals("SPEC_TEACHER")) {
                        M.addBehavior(CMClass.getBehavior("MOBTeacher"));
                    } else if (special.equals("SPEC_BUDDHA")) {
                        M.addBehavior(CMClass.getBehavior("Clericness"));
                        M.addAbility(CMClass.getAbility("Dragonbreath"));
                    } else if (special.equals("SPEC_DEATH_RAIN")) {
                        Log.errOut("IMPORT", "Unsupported spec: " + special);
                    } else if (special.equals("SPEC_HEALER"))
                        M.addBehavior(CMClass.getBehavior("Healer"));
                    else if (special.equals("SPEC_REPAIRMAN"))
                        M.addBehavior(CMClass.getBehavior("ItemMender"));
                    else if ((special.equals("SPEC_SUMMON_LIGHT"))
                        || (special.equals("SPEC_SUMMON_DEMON"))) {
                        M.addBehavior(CMClass.getBehavior("CombatAbilities"));
                        M.addAbility(CMClass.getAbility("Prayer_SummonElemental"));
                    } else if (special.equals("SPEC_EXECUTIONER"))
                        M.addBehavior(CMClass.getBehavior("GoodExecutioner"));
                    else if (special.startsWith("SPEC_ASSASSIN")) {
                        ...
                        M.addBehavior(B);
                    } else if (special.equals("SPEC_CAST_ADEPT"))
                        M.addBehavior(CMClass.getBehavior("Healer"));
                    else if (special.equals("SPEC_CAST_CLERIC"))
                        M.addBehavior(CMClass.getBehavior("Clericness"));
                    else if (special.equals("SPEC_NASTY"))
                        M.addBehavior(CMClass.getBehavior("FightFlee"));
                    else if (special.equals("SPEC_DARK_MAGIC")) {
                        M.addNonUninvokableEffect(CMClass.getAbility("Spell_SpellTurning"));
                        M.addAbility(CMClass.getAbility("Prayer_Heal"));
                    } else if (special.equals("SPEC_SMART"))
                        M.addBehavior(CMClass.getBehavior("Scavenger"));
                    else if (special.equals("SPEC_CAST_UNDEAD")) {
                        ...
                        M.baseCharStats().getMyRace().startRacing(M, false);
                    } else if ((special.equals("SPEC_GUARD"))
                    ...
                    else if (special.equals("SPEC_FIDO"))
                        M.addBehavior(CMClass.getBehavior("CorpseEater"));
                    else if ((special.equals("SPEC_MAYOR"))
                        || (special.equals("SPEC_CAPTAIN")))
                        M.addBehavior(CMClass.getBehavior("MudChat"));
                    else if (special.equals("SPEC_JANITOR"))
                        M.addBehavior(CMClass.getBehavior("Scavenger"));
                    else if (special.equals("SPEC_BREATH_ANY")) {
                        M.addBehavior(CMClass.getBehavior("CombatAbilities"));
                        M.addAbility(CMClass.getAbility("Dragonbreath"));
                    } else if (special.equals("SPEC_CAST_CADAVER")) {
                        M.addBehavior(CMClass.getBehavior("CombatAbilities"));
                        M.addAbility(CMClass.getAbility("Prayer_Bury"));
                    } else if ((special.equals("SPEC_REWIELD"))
                        || (special.equals("SPEC_WIZARDOFOZ"))
                        || (special.equals("SPEC_VAMP_HUNTER"))
                        || (special.equals("SPEC_MINO_GUARD"))) {
                        // who knows?
                    } else if (special.equals("SPEC_TAX_MAN")) {
                        M.addBehavior(CMClass.getBehavior("RandomTeleporter"));
                        M.addBehavior(CMClass.getBehavior("Thiefness"));
                    } else if (special.equals("SPEC_STEPHEN")) {
                        M.addBehavior(CMClass.getBehavior("RandomTeleporter"));
                        M.addBehavior(CMClass.getBehavior("Healer"));
                    ...
                    } else if (special.equals("SPEC_CAST_JUDGE")) {
                        M.addBehavior(CMClass.getBehavior("CombatAbilities"));
                        M.addAbility(CMClass.getAbility("Skill_Explosive"));
                    } else if (special.equals("SPEC_BREATH_FIRE")) {
                        M.addBehavior(CMClass.getBehavior("CombatAbilities"));
                        M.addAbility(CMClass.getAbility("Firebreath"));
                    } else if (special.equals("SPEC_BREATH_FROST")) {
                        M.addBehavior(CMClass.getBehavior("CombatAbilities"));
                        M.addAbility(CMClass.getAbility("Frostbreath"));
                    } else if (special.equals("SPEC_BREATH_GAS")) {
                        M.addBehavior(CMClass.getBehavior("CombatAbilities"));
                        M.addAbility(CMClass.getAbility("Gasbreath"));
                    } else if (special.equals("SPEC_BREATH_LIGHTNING")) {
                        M.addBehavior(CMClass.getBehavior("CombatAbilities"));
                        M.addAbility(CMClass.getAbility("Lighteningbreath"));
                    } else if (special.equals("SPEC_POISON")) {
                        M.addBehavior(CMClass.getBehavior("CombatAbilities"));
                        M.addAbility(CMClass.getAbility("Poison"));
                    } else if (special.equals("SPEC_OGRE_MEMBER")) {
                        final Behavior B = CMClass.getBehavior("ROMGangMember");
                        B.setParms("Ogre");
                        M.addBehavior(B);
                    } else if (special.equals("SPEC_TROLL_MEMBER")) {
                        final Behavior B = CMClass.getBehavior("ROMGangMember");
                        B.setParms("Troll");
                        M.addBehavior(B);
                    } else if (special.equals("SPEC_PATROLMAN"))
                        M.addBehavior(CMClass.getBehavior("ROMPatrolman"));
                    else
                        returnAnError(session, "Unknown mob special: " + special, compileErrors, commands);
                } else if ((s.startsWith("#SPE")) || (s.startsWith("S")) || (s.startsWith("*") || (s.startsWith("#$")) || (s.startsWith("R ")))) {
                } else if (s.trim().length() > 0)
    ...
    private static Item getItem(String OfThisID,
        ...
        for (int o = 0; o < objectData.size(); o++) {
            ...
            else if (objectData.get(o) instanceof String) {
            ...
            switch (objType) {
                ...
                case 17:
                    ...
                    } else if (str3.indexOf("FIREBREATHER") >= 0) {
                        ((Drink) I).setLiquidType(RawMaterial.RESOURCE_LIQUOR);
                        I.addEffect(CMClass.getAbility("Poison_Firebreather"));
                        ((Drink) I).setLiquidHeld(val1 * 10);
                        ((Drink) I).setLiquidRemaining(val2);
                    } else if (str3.indexOf("LOCAL SPECIALTY") >= 0) {
                        ((Drink) I).setLiquidType(RawMaterial.RESOURCE_LIQUOR);
                        I.addEffect(CMClass.getAbility("Poison_Liquor"));
                        ((Drink) I).setLiquidHeld(val1 * 10);
                        ((Drink) I).setLiquidRemaining(val2);
                    } else if (str3.indexOf("WHISKEY") >= 0) {
                        ((Drink) I).setLiquidType(RawMaterial.RESOURCE_LIQUOR);
                        I.addEffect(CMClass.getAbility("Poison_Liquor"));
                        ((Drink) I).setLiquidHeld(val1 * 10);
                        ((Drink) I).setLiquidRemaining(val2);
                    } else if ((val4 > 0) || (str3.indexOf("POISON") >= 0)) {
            ...
            if ((I instanceof Container) && (((Container) I).containTypes() == Container.CONTAIN_ANYTHING)) {
                ...
                } else if (CMLib.english().containsString(objectName, "boot")
            ...
            while (objV.size() > 0) {
                ...
                if (codeLine.equals("E")) {
                    ...
                    if ((CMClass.getItem(I.ID()) != null)
                        ...
                        I.setDescription("");
                    else if (I.description().length() > 0)
                    ...
                    if (CMParms.numBits(codesLine) != 4)
                        ...
                        if (codeType.equals("V")) {
                            ...
                            for (int rei = 0; rei < resistances.length; rei++) {
                                ...
                                else if ((CMath.isSet(imm, rei)) && (resistances[rei].length() > 0))
                    ...
                    eatNextLine(objV);
                    // eos support
                } else if ((codeLine.startsWith("#")) || (codeLine.length() == 0)) {
                    eatNextLine(objV);
    ...
    public static Room applyRoomCodeBits(Room R, Room lastRoom, Map<Room, Room> petShops, long codeBits, boolean circleFormat) {
        ...
        if (circleFormat) {
            ...
            if (CMath.isSet(codeBits, 12))
                petShops.put(R, R);
            else if ((lastRoom != null) && (petShops.get(lastRoom) != null) && (petShops.get(lastRoom) == lastRoom)) {
    ...
    protected void importCustomObjects(MOB mob, List<CMObject> custom, Set<String> customBother, boolean noPrompt, boolean noDelete)
        ...
        for (int c = 0; c < custom.size(); c++) {
            ...
            } else if (custom.get(c) instanceof CharClass) {
            ...
            } else if (custom.get(c) instanceof Ability) {
            ...
            } else if (custom.get(c) instanceof Manufacturer) {
    ...
    public boolean executeImporter(MOB mob, List<Object> commands) throws java.io.IOException {
        ...
        for (int i = 0; i < commands.size(); i++) {
            if (commands.get(i) instanceof String) {
                ...
                if (s.equalsIgnoreCase("nodelete")) {
                    ...
                    i--;
                    nodelete = true;
                } else if (s.equalsIgnoreCase("noprompt")) {
                    commands.remove(i);
                    i--;
                    prompt = false;
                } else if (s.toLowerCase().startsWith("areatype=")) {
                    s = s.substring(9);
        ...
        while (commands.size() > 0) {
            ...
            } else if (O instanceof java.util.zip.ZipInputStream) {
                ...
                if ((buf != null) && (buf.length() > 20) && (buf.substring(0, 20).indexOf("<AREAS>") >= 0)) {
                    ...
                    while (areas.size() > 0) {
                        ...
                        if (error.startsWith("Area Exists: ")) {
                            ...
                            else if (((!prompt) || ((session != null) && session.confirm(L("Area: \"@x1\" exists, obliterate first?", areaName), "N")))) {
                                if (reLinkTable == null)
                    ...
                    continue;
                } else if ((buf != null) && (buf.length() > 20) && (buf.substring(0, 20).indexOf("<AREA>") >= 0)) {
                    if (!CMSecurity.isAllowedEverywhere(mob, CMSecurity.SecFlag.IMPORTROOMS)) {
                    ...
                    continue;
                } else if ((buf != null) && (buf.length() > 20) && (buf.substring(0, 20).indexOf("<AROOM>") >= 0)) {
                    if (!CMSecurity.isAllowedEverywhere(mob, CMSecurity.SecFlag.IMPORTROOMS)) {
                    ...
                    continue;
                } else if ((buf != null) && (buf.length() > 20) && (buf.substring(0, 20).indexOf("<CATALOG") >= 0)) {
                    ...
                    continue;
                } else if ((buf != null) && (buf.length() > 20) && (buf.substring(0, 20).indexOf("<MOBS>") >= 0)) {
                    if (!CMSecurity.isAllowed(mob, mob.location(), CMSecurity.SecFlag.IMPORTMOBS)) {
                    ...
                    if (session != null)
                        session.println(L("MOB(s) successfully imported!"));
                    continue;
                } else if ((buf != null) && (buf.length() > 20) && ((buf.substring(0, 20).indexOf("<PLAYERS>") >= 0) || (buf.substring(0, 20).indexOf("<ACCOUNTS>") >= 0))) {
                    ...
                    for (int m = 0; m < accounts.size(); m++) {
                        ...
                        if (CMLib.players().accountExists(A.getAccountName())) {
                            if (!prompt) {
                                ...
                                continue;
                            } else if ((session != null) && (!session.confirm(L("Account: \"@x1\" exists, obliterate first?", A.getAccountName()), "Y")))
                                continue;
                            else
                    ...
                    for (int m = 0; m < mobs.size(); m++) {
                        ...
                        if (CMLib.players().playerExists(M.Name())) {
                            if (!prompt) {
                                ...
                                continue;
                            } else if ((session != null) && (!session.confirm(L("Player: \"@x1\" exists, obliterate first?", M.Name()), "Y")))
                                continue;
                            else
                    ...
                    continue;
                } else if ((buf != null) && (buf.length() > 20) && (buf.substring(0, 20).indexOf("<ITEMS>") >= 0)) {
            ...
            try {
                ...
                } else if ((prompt) && ((session != null) && (!session.confirm(L("Found area: \"@x1\", is this ok?", areaName), "Y")))) {
                    if (multiArea)
                        continue;
                    return false;
                }
                ...
                for (int r = 0; r < roomData.size(); r++) {
                    ...
                    if (roomData.get(r) instanceof List) {
                        ...
                        if ((roomV.size() == 1)
                            ...
                            continue;
                    } else if (roomData.get(r) instanceof String) {
                ...
                for (int r = 0; r < roomData.size(); r++) {
                    ...
                    while (roomV.size() > 0) {
                        ...
                        if (nextLine.toUpperCase().startsWith("S"))
                            ...
                            else if ((dirCode == 10) && (Directions.NUM_DIRECTIONS() < 10))
                                dirCode = Directions.GATE;
                            else
                                for (int d = Directions.NUM_DIRECTIONS() - 1; d >= 0; d--) {
                                    if (R.rawDoors()[d] == null) {
                            ...
                            {
                                /* all is well */
                            } else if (CMParms.numBits(codeStr) == 4) {
								/* all is still well -- from the wld format I guess. */
                            } else if (CMParms.numBits(codeStr) == 5) {
								/*TODO:BZ all is still well -- from wierd modified rom. */
                            } else if (CMParms.numBits(codeStr) != 3) {
                        ...
                        } else if (nextLine.toUpperCase().startsWith("M")) {
                            // mana heal rate
                            // not important enough to generate an error from
                        } else if (nextLine.toUpperCase().startsWith("R")) {
                            // R ERROR 700 100~
                            // No idea what this is.  Not important enough to generate an error from
                        } else if (nextLine.toUpperCase().startsWith("C")) {
                        ...
                        } else if (nextLine.toUpperCase().startsWith("H")) {
                            // hit point heal rate
                            // not important enough to generate an error from
                            ...
                            // nothing done with the script. :(
                        } else if (nextLine.toUpperCase().startsWith("O")) {
                            // ?
                            // not important enough to generate an error from
                        } else if (nextLine.startsWith("Rd")) {
                            // some sort of eos thang
                            // not important enough to generate an error from
                        } else if (nextLine.trim().equals("|")) {
                            // ?
                            // not important enough to generate an error from
                        } else if ((!nextLine.equalsIgnoreCase("#0")) && (nextLine.trim().length() > 0))
                ...
                while (resetData.size() > 0) {
                    ...
                    if ((s.startsWith("#RE")) || (s.startsWith("*")) || (s.startsWith("S"))) {
                        ...
                        if (M == null) {
                            ...
                            if (I == null) {
                                ...
                                if (M instanceof ShopKeeper) {
                                    ...
                                    } else if (((ShopKeeper) M).isSold(ShopKeeper.DEAL_WEAPONS)) {
                        ...
                        if (I == null) {
                        ...
                        } else if (C.owner() instanceof Room) {
                            ...
                            if (I instanceof Container)
                                containerHash.put(itemID, (Container) I);
                        } else if (C.owner() instanceof MOB) {
