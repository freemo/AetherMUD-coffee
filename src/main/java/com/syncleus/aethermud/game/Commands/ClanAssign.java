...
import com.planet_ink.game.Common.interfaces.Clan.Authority;
import com.planet_ink.game.Common.interfaces.Clan.Function;
            ...
            if (skipChecks || CMLib.clans().goForward(mob, C, commands, Clan.Function.ASSIGN, false)) {
                ...
                if (found) {
                    ...
                    if (skipChecks || CMLib.clans().goForward(mob, C, commands, Clan.Function.ASSIGN, true)) {
                        ...
                        if (topRoleIDs.contains(Integer.valueOf(oldPos))) { // If you WERE already the highest order.. you must be being demoted.
