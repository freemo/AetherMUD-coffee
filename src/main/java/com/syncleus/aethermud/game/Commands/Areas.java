...
import com.syncleus.aethermud.game.Areas.interfaces.Area.Stats;
    ...
    public boolean execute(MOB mob, List<String> commands, int metaFlags)
        ...
        for (int i = 1; i < commands.size(); i++) {
            ...
            if (s.toUpperCase().startsWith("SORT=NA")) {
                ...
                commands.remove(i);
                i--;
            } else if (s.toUpperCase().startsWith("SORT=REV")) {
                ...
                commands.remove(i);
                i--;
            } else if (s.toUpperCase().startsWith("SORT=LEV")) {
                final List<Area> levelSorted = new ArrayList<Area>();
                ...
                commands.remove(i);
                i--;
            } else if (s.toUpperCase().startsWith("SORT=AUTH")) {
                final List<Area> levelSorted = new ArrayList<Area>();
                for (; a.hasMoreElements(); ) levelSorted.add(a.nextElement());
                Collections.sort(levelSorted, new Comparator<Area>() {
                    @Override
                ...
                numCols = 2;
                i--;
            } else if (s.toUpperCase().startsWith("SORT=")) {
                int statVal = -1;
