...
import com.syncleus.aethermud.game.Libraries.interfaces.TelnetFilter;
            ...
            while ((loop < len) && (buf.length() > loop)) {
                switch (buf.charAt(loop)) {
                    ...
                    case '&':
                        if (loop < amperStop)
                            break;
                        else if (loop < buf.length() - 3) {
                            if (buf.substring(loop, loop + 3).equalsIgnoreCase("lt;"))
                                buf.replace(loop, loop + 3, "<");
                            else if (buf.substring(loop, loop + 3).equalsIgnoreCase("gt;"))
                                buf.replace(loop, loop + 3, ">");
                        }
                        break;
                    case '%':
                ...
                if ((S != null) && (S.getClientTelnetMode(Session.TELNET_ANSI))) {
                    ...
                    if (lastColor.backgroundCode() == '.')
                        ...
                        if (lastColor.backgroundCode() < 256) {
                            ...
                            else if (ColorLibrary.MAP_ANSICOLOR_TO_ANSIBGCOLOR.containsKey(bgEscapeSequence))
                                ...
                                if (P == null) {
                                    ...
                                    switch (P) {
                                        case NAME: {
                                            ...
                                            else if (regarding instanceof PhysicalAgent)
                                        ...
                                        case NAMESELF: {
                                            if (regarding == null)
                                                replacement = "";
                                            else if (((source == target) || (target == null)) && (mob == regarding))
