...
public class CMColor extends StdLibrary implements ColorLibrary {
    ...
    public String mixHTMLCodes(String code1, String code2) {
        ...
        if ((code1 == null) || (code1.length() == 0))
            ...
            html = code1;
        else if (code1.startsWith(" ") && (code2.startsWith("<FONT")))
            html = code2 + code1;
        else if (code2.startsWith(" ") && (code1.startsWith("<FONT")))
            html = code1 + code2;
        else if (code1.startsWith("<") && (code2.startsWith("<")))
            html = code1 + ">" + code2;
        else if (!code1.startsWith("<"))
            html = code2;
        else
            html = code1;
        if (html.startsWith(" "))
