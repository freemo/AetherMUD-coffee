...
import com.syncleus.aethermud.game.Libraries.interfaces.ItemBalanceLibrary;
import com.syncleus.aethermud.game.core.CMClass;
import com.syncleus.aethermud.game.core.CMLib;
import com.syncleus.aethermud.game.core.CMath;
import com.syncleus.aethermud.game.core.Resources;
import com.syncleus.aethermud.game.core.interfaces.AbilityContainer;
...
public class TimsLibrary extends StdLibrary implements ItemBalanceLibrary {
        ...
        for (int i = 0; i < I.numEffects(); i++) {
            ...
            if (A instanceof TriggeredAffect) {
                ...
                if (CMath.bset(flags, Ability.FLAG_ADJUSTER)
                    ...
                    RET[0] = A;
                else if (CMath.bset(flags, Ability.FLAG_RESISTER)
                    && ((triggers & (TriggeredAffect.TRIGGER_WEAR_WIELD | TriggeredAffect.TRIGGER_GET | TriggeredAffect.TRIGGER_MOUNT)) > 0))
                    RET[1] = A;
                else if (CMath.bset(flags, Ability.FLAG_CASTER)
                    && (triggers > 0)) {
                    RET[2] = A;
    ...
    public boolean itemFix(Item I, int lvlOr0, StringBuffer changes) {
        ...
        if ((I instanceof SpellHolder)
            ...
            else if ((I instanceof Wand) && (((Wand) I).getSpell() != null))
    ...
    public void toneDownWeapon(Weapon W, Ability ADJ) {
        ...
        else if (W.basePhyStats().damage() > 1)
        ...
        else if (W.basePhyStats().attackAdjustment() > 1)
    ...
    public void toneDownArmor(Armor A, Ability ADJ) {
        ...
        else if (fixit && (A.basePhyStats().armor() > 1))
