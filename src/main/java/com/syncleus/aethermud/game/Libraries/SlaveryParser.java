...
import com.planet_ink.game.Libraries.interfaces.SlaveryLibrary;
...
//TELL <CHAR> <WHAT>
            ...
            if (!done)
                for (int s = 0; s < size(); s++) {
                    ...
                    if (ss.equalsIgnoreCase("HOLD")) {
                        ...
                        holdFlag = true;
                        break;
                    } else if (ss.equalsIgnoreCase("MOVE"))
                        moveFlag = true;
    ...
    public static class GeasStepImpl implements GeasStep {
        ...
        public String step() {
            ...
            if (s.equalsIgnoreCase("itemfind")) {
            ...
            } else if (s.equalsIgnoreCase("mobfind")) {
                ...
                return "MOVE";
            } else if (s.equalsIgnoreCase("wanderquery")) {
                if (CMSecurity.isDebugging(CMSecurity.DbgFlag.GEAS))
