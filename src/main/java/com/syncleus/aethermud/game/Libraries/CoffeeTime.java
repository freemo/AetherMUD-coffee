...
public class CoffeeTime extends StdLibrary implements TimeManager {
    ...
    public Calendar string2Date(String dateTimeStr) {
        ...
        if ((dateTimeStr.indexOf('.') == 19)
            ...
            if (dateTimeStr.trim().endsWith("PM"))
                AP = Calendar.PM;
            else if (dateTimeStr.trim().endsWith("AM"))
                AP = Calendar.AM;
            else if (HH == 0) {
                HH = 12;
                AP = Calendar.AM;
                ...
                HH = HH - 12;
                AP = Calendar.PM;
            } else if (dateTimeStr.toUpperCase().substring(10).indexOf('P') >= 0)
                AP = Calendar.PM;
            else if (dateTimeStr.toUpperCase().substring(10).indexOf('A') >= 0)
                AP = Calendar.AM;
    ...
    private void confirmDateAMPM(String TheDate, Calendar D) {
        try {
            ...
            } else if (TheDate.trim().endsWith("AM")) {
