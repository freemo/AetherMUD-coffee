...
import com.syncleus.aethermud.game.core.collections.MultiEnumeration.MultiEnumeratorBuilder;
...
public class CMMap extends StdLibrary implements WorldMap {
    ...
    public Area areaLocation(CMObject E) {
        ...
        else if ((E instanceof Ability) && (((Ability) E).affecting() != null))
                    ...
                    myFiles.add(new CMFile.CMVFSFile(this.getPath() + statName, 256, System.currentTimeMillis(), "SYS") {
                        ...
                        public int getMaskBits(MOB accessor) {
                            ...
                            if ((E instanceof Area) && (CMSecurity.isAllowed(accessor, ((Area) E).getRandomProperRoom(), CMSecurity.SecFlag.CMDAREAS)))
                                return this.mask;
                            else if (CMSecurity.isAllowed(accessor, R, CMSecurity.SecFlag.CMDROOMS))
                                return this.mask;
                            else if ((E instanceof MOB) && CMSecurity.isAllowed(accessor, R, CMSecurity.SecFlag.CMDMOBS))
                                return this.mask;
                            else if ((E instanceof Item) && CMSecurity.isAllowed(accessor, R, CMSecurity.SecFlag.CMDITEMS))
                                return this.mask;
                            return this.mask | 48;
                        }
    ...
    public double getMinDistanceFrom(SpaceObject FROM, long prevDistance, SpaceObject TO) {
        ...
        else if (anglePrevDistance > 1.5708)
