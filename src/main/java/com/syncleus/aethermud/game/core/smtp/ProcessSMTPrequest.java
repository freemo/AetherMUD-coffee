            ...
            while (!quitFlag) {
                ...
                while (cmdQueue.size() > 0) {
                    ...
                    if ((dataMode) && (s.equals("."))) {
                        ...
                        if (data.length() >= server.getMaxMsgSize())
                            ...
                            try {
                                ...
                                while (true) {
                                    ...
                                    if ((startBuffering) && (boundry != null) && (s2.indexOf(boundry) >= 0)) {
                                    ...
                                    } else if ((s2u.startsWith("CONTENT TYPE: ") || s2u.startsWith("CONTENT-TYPE: "))) {
                                        ...
                                        } else if (s2u.substring(14).trim().startsWith("TEXT/HTML")) {
                                            if (boundryState == 2)
                                                boundryState = -1;
                                            bodyType = 'h';
                                        } else if (!s2u.substring(14).trim().startsWith("TEXT/PLAIN")) {
                                            bodyType = 't';
                                            if (boundryState == 2)
                                                boundryState = 0;
                                            else {
                        ...
                        } else if (parm.equals("NOOP")) {
                            replyData = (
                                "214-NOOP" + cr +
                                    "214-    Do nothing." + cr +
                                    "214 End of HELP info" + cr).getBytes();
                        } else if (parm.equals("HELO")) {
                            replyData = (
                                "214-HELO <hostname>" + cr +
                                    "214-    Introduce yourself." + cr +
                                    "214 End of HELP info" + cr).getBytes();
                        } else if (parm.equals("EHLO")) {
                            replyData = (
                                "214-EHLO" + cr +
                            ...
                            if (!to2.equalsIgnoreCase("to"))
                                ...
                                if (parm.indexOf('@') < 0)
                                    ...
                                    if (name == null) {
                                        ...
                                        } else if (CMLib.database().DBCountJournal(server.mailboxName(), null, name) >= server.getMaxMsgs())
