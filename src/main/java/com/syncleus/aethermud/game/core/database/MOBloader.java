...
public class MOBloader {
    ...
    protected List<Pair<String, Integer>>[][] DBFindPrideWinners(int topThisMany, short scanCPUPercent, boolean players) {
        @SuppressWarnings("unchecked")        final List<Pair<String, Integer>>[][] top = new Vector[TimeClock.TimePeriod.values().length][AccountStats.PrideStat.values().length];
        ...
        try {
            ...
            while ((R != null) && (R.next())) {
                ...
                else if ((M != null) && (M.playerStats() != null) && (!players) && (M.playerStats().getAccount() != null))
    ...
    public PlayerLibrary.ThinnerPlayer DBUserSearch(String Login) {
        ...
        if ((buf != null) && (thinPlayer != null)) {
            ...
            else if (CMLib.xml().returnXMLValue(buf, "ACCTEXP").length() > 0)
