...
import com.syncleus.aethermud.game.core.collections.ConvertingIterator;
import com.syncleus.aethermud.game.core.collections.ConvertingList;
...
public class StdThinGrid extends StdRoom implements GridLocale {
    ...
    protected void fillExitsOfGridRoom(Room R, int x, int y) {
        ...
        if (Directions.NORTHEAST < Directions.NUM_DIRECTIONS()) {
            ...
            } else if ((rawDoors()[Directions.NORTHWEST] != null) && (exits[Directions.NORTHWEST] != null))
            ...
            } else if ((rawDoors()[Directions.SOUTHWEST] != null) && (exits[Directions.SOUTHWEST] != null))
            ...
            } else if ((rawDoors()[Directions.NORTHEAST] != null) && (exits[Directions.NORTHEAST] != null))
            ...
            } else if ((rawDoors()[Directions.SOUTHEAST] != null) && (exits[Directions.SOUTHEAST] != null))
