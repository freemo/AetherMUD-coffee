...
public class EndlessThinSky extends StdThinGrid {
    ...
    protected void fillExitsOfGridRoom(final Room R, final int x, final int y) {
        ...
        } else if (doorsR[Directions.UP] == null) {
            if (y > 0) {
        ...
        } else if (doorsR[Directions.DOWN] == null) {
            if (y < yGridSize() - 1) {
                R2 = getMakeSingleGridRoom(x, y + 1);
                if (R2 != null)
        ...
        } else if ((y == yGridSize() - 1) && (doorsR[Directions.SOUTH] == null)) {
        ...
        } else if ((x == xGridSize() - 1) && (doorsR[Directions.EAST] == null)) {
        ...
        if (Directions.NORTHEAST < Directions.NUM_DIRECTIONS()) {
            ...
            } else if (((x == xGridSize() - 1) || (y == yGridSize() - 1)) && (doorsR[Directions.SOUTHEAST] == null)) {
                R2 = getMakeSingleGridRoom(0, 0);
                if (R2 != null)
            ...
            } else if (((x == 0) || (y == yGridSize() - 1)) && (doorsR[Directions.SOUTHWEST] == null)) {
