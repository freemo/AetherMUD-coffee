...
import com.syncleus.aethermud.game.Behaviors.interfaces.MobileBehavior;
            ...
            if (acquittableLaws != null) {
                for (final String brokenLaw : acquittableLaws) {
                    if ((laws.basicCrimes().containsKey(brokenLaw)) && (laws.basicCrimes().get(brokenLaw) != null)) {
                        ...
                        break;
                    } else if ((laws.taxLaws().containsKey(brokenLaw)) && (laws.taxLaws().get(brokenLaw) instanceof String[])) {
                        info = (String[]) laws.taxLaws().get(brokenLaw);
                        break;
                    } else if ((laws.abilityCrimes().containsKey(brokenLaw)) && (laws.abilityCrimes().get(brokenLaw) != null)) {
    ...
    public String restOfCharges(Law laws, MOB mob) {
        ...
        for (int w = 0; (laws.getWarrant(mob, w) != null); w++) {
            ...
            if (W != null) {
                ...
                else if (laws.getWarrant(mob, w + 1) == null)
    ...
    public boolean fillOutWarrant(MOB criminalM,
        ...
        if (crimeFlags.trim().length() > 0) {
            ...
            for (int v = 0; v < V.size(); v++) {
                ...
                if (str.endsWith("WITNESS") && (str.length() < 9)) {
                    ...
                    else if ((witness != null) && (witness.location() != criminalM.location())) {
                        if (CMSecurity.isDebugging(CMSecurity.DbgFlag.ARREST))
                ...
                } else if (str.startsWith("IGNORE") && (str.length() < 9)) {
                ...
                } else if (str.startsWith("!IGNORE") && (str.length() < 10)) {
                ...
                } else if (str.endsWith("COMBAT") && (str.length() < 8)) {
                ...
                } else if (str.endsWith("RECENTLY") && (str.length() < 10)) {
        ...
        if (crimeLocs.trim().length() > 0) {
            ...
            for (int v = 0; v < V.size(); v++) {
                ...
                if (str.endsWith("INDOORS") && (str.length() < 9)) {
                    ...
                    aCrime = true;
                } else if (str.endsWith("HOME") && (str.length() < 6)) {
                    ...
                    aCrime = true;
                } else if (str.startsWith("!") && (CMLib.english().containsString(display, str.substring(1)))) {
                    if (CMSecurity.isDebugging(CMSecurity.DbgFlag.ARREST))
                    ...
                    return false;
                } else if (CMLib.english().containsString(display, str)) {
                    aCrime = true;
                    break;
                }
            }
        ...
        if ((isStillACrime(W, CMSecurity.isDebugging(CMSecurity.DbgFlag.ARREST)))
            ...
            if (!addWarrant(laws, W))
                return false;
        } else if (CMSecurity.isDebugging(CMSecurity.DbgFlag.ARREST))
        ...
        switch (W.state()) {
            case Law.STATE_SEEKING: {
                ...
                if ((officer != null)
                    ...
                    } else if (W.crime().equalsIgnoreCase("pardoned")) {
                        fileAllWarrants(laws, W, W.criminal());
                        unCuff(W.criminal());
                        W.setArrestingOfficer(myArea, null);
                    } else if (judgeMe(laws, null, officer, W.criminal(), W, myArea, debugging)) {
                        fileAllWarrants(laws, W, W.criminal());
                        unCuff(W.criminal());
                        dismissOfficer(officer);
                        W.setArrestingOfficer(myArea, null);
                    } else if (W.state() != Law.STATE_DETAINING) {
                ...
                if ((officer != null)
                    ...
                    if (officer.isInCombat()) {
                        ...
                        if (CMLib.flags().isSitting(W.criminal()) || CMLib.flags().isSleeping(W.criminal())) {
                            ...
                            W.setState(Law.STATE_SUBDUEING);
                        } else if ((System.currentTimeMillis() - W.getLastStateChangeTime()) > (CMath.mul(CMProps.getTickMillis(), 1.5))) // only leave this state after they've had enough time.
                        {
                            W.setState(Law.STATE_SUBDUEING);
            ...
            case Law.STATE_SUBDUEING: {
                if ((officer != null)
                    ...
                    if (W.crime().equalsIgnoreCase("pardoned")) {
                        ...
                        unCuff(W.criminal());
                        W.setArrestingOfficer(myArea, null);
                    } else if (CMLib.flags().isStanding(W.criminal())) {
            ...
            case Law.STATE_MOVING: {
                if ((officer != null)
                    ...
                    else if (!CMLib.flags().isTracking(officer)) {
                        if (!trackTheJudge(officer, myArea, laws)) {
                    ...
                    } else if ((CMLib.dice().rollPercentage() > 75) && (laws.chitChat().size() > 0))
            ...
            case Law.STATE_REPORTING: {
                if ((officer != null)
                    ...
                    } else if (CMLib.flags().isAliveAwakeMobile(judge, true)) {
                        CMLib.tracking().stopTracking(officer);
                        W.setTravelAttemptTime(0);
                        String sirmaam = "Sir";
            ...
            case Law.STATE_MOVING2: {
                if ((officer != null)
                    ...
                    } else if ((CMLib.dice().rollPercentage() > 75) && (laws.chitChat2().size() > 0))
                ...
                if ((officer != null)
                    ...
                    if (W.jail() == W.criminal().location()) {
                        ...
                        if (W.criminal().fetchEffect("Prisoner") == null) {
                            ...
                            W.setState(Law.STATE_RELEASE);
                    } else if (CMLib.flags().flaggedAffects(officer, Ability.FLAG_TRACKING).size() == 0) {
                        final Ability A = CMClass.getAbility("Skill_Track");
                        if (A != null) {
                            CMLib.tracking().stopTracking(officer);
                            A.setAbilityCode(1); // tells track to cache the path
                    ...
                    } else if ((CMLib.dice().rollPercentage() > 75) && (laws.chitChat3().size() > 0))
            ...
            case Law.STATE_RELEASE: {
                if (((W.criminal().fetchEffect("Prisoner") == null) || (W.crime().equalsIgnoreCase("pardoned")))
                    ...
                    if (CMath.bset(highestCrimeAction(laws, W, W.criminal()), Law.PUNISHMENTMASK_NORELEASE)) {
                        ...
                        unCuff(W.criminal());
                        W.setArrestingOfficer(myArea, null);
                    } else if (W.criminal().location() == W.jail()) {
                        if ((officer == null)
                            || (!CMLib.flags().isAliveAwakeMobile(officer, true))
                            || (W.criminal().amDead())
                            || (!CMLib.flags().isInTheGame(W.criminal(), true))
