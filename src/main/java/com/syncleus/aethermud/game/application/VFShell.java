...
import com.planet_ink.game.Commands.Shell;
import com.planet_ink.game.Common.FakeSession;
...
import com.planet_ink.game.MOBS.StdMOB;
    ...
    public static void main(final String[] args) {
        ...
        Thread t = new Thread(g, new Runnable() {
            ...
            public void run() {
                ...
                CMSecurity.instance();
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.AutoTitles());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CMJournals());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.BeanCounter());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CharCreation());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.Clans());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CMAbleMap());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CMAbleParms());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CMCatalog());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CMChannels());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CMColor());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CMMap());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CoffeeMaker());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.MUDPercolator());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.EnglishParser());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CoffeeUtensils());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CMEncoder());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CMGenEditor());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CoffeeFilter());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CMLister());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.Dice());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.DirtyLanguage());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.Sense());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.XMLManager());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.MUDZapper());
                CMLib.registerLibrary(new com.planet_ink.game.Libraries.CoffeeTime());
                CMClass.addClass(CMObjectType.COMMON, new com.planet_ink.game.Common.DefaultCharState());
                CMClass.addClass(CMObjectType.COMMON, new com.planet_ink.game.Common.DefaultCharStats());
                CMClass.addClass(CMObjectType.COMMON, new com.planet_ink.game.Common.DefaultPhyStats());
