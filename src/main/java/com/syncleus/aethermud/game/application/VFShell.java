...
import com.syncleus.aethermud.game.Commands.Shell;
    ...
    public static void main(final String[] args) {
        ...
        Thread t = new Thread(g, new Runnable() {
            ...
            public void run() {
                ...
                CMSecurity.instance();
                CMLib.registerLibrary(new com.syncleus.aethermud.game.Libraries.AutoTitles());
                CMLib.registerLibrary(new com.syncleus.aethermud.game.Libraries.CMJournals());
                CMLib.registerLibrary(new com.syncleus.aethermud.game.Libraries.BeanCounter());
                CMLib.registerLibrary(new com.syncleus.aethermud.game.Libraries.CharCreation());
                CMLib.registerLibrary(new com.syncleus.aethermud.game.Libraries.Clans());
                CMLib.registerLibrary(new com.syncleus.aethermud.game.Libraries.CMAbleMap());
                CMLib.registerLibrary(new com.syncleus.aethermud.game.Libraries.CMAbleParms());
                CMLib.registerLibrary(new com.syncleus.aethermud.game.Libraries.CMCatalog());
