    ...
    public boolean invoke(MOB mob, List<String> commands, Physical givenTarget, boolean auto, int asLevel) {
        ...
        if (nonPlayerData == null) {
            ...
            if (!playerCorpse) {
                ...
                } else if (!canResurrectNormalMobs()) {
        ...
        if (success) {
            ...
            if (mob.location().okMessage(mob, msg)) {
                ...
                else if ((nonPlayerData != null) && (body != null)) {
                ...
                } else if (this.canResurrectNormalMobs() && (body instanceof DeadBody) && (((DeadBody) body).getSavedMOB() != null)) {
