...
public class Shipwright extends CraftingSkill implements ItemCraftor, MendingSkill {
    ...
    public void unInvoke() {
        if (canBeUninvoked()) {
            if (affected instanceof MOB) {
                ...
                } else if ((activity == CraftingActivity.DOORING)
                    && (!aborted)) {
                    if ((messedUp) || (mob.location() != activityRoom))
                ...
                } else if ((activity == CraftingActivity.DEMOLISH)
                    && (!aborted)) {
                    if ((messedUp) || (mob.location() != activityRoom))
    ...
    protected boolean autoGenInvoke(final MOB mob, List<String> commands, Physical givenTarget, final boolean auto,
        ...
        } else if (str.equalsIgnoreCase("demolish")) {
            buildingI = null;
            activity = CraftingActivity.CRAFTING;
            key = null;
            messedUp = false;
        ...
        } else if (activity == CraftingActivity.RETITLING) {
            messedUp = false;
