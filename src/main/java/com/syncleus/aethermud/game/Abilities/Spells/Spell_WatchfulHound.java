    ...
    public void executeMsg(final Environmental myHost, final CMMsg msg) {
        ...
        if (affected instanceof MOB) {
            ...
            if (invoker != null) {
                ...
                } else if ((msg.targetMinor() == CMMsg.TYP_ENTER) && (msg.target() == mob.location())) {
                    if ((invoker.location() != mob.location()) || (!CMLib.flags().isInTheGame(invoker, true)))
                        unInvoke();
                    else if (CMLib.flags().isPossiblyAggressive(msg.source())) {
                ...
                } else if (((!invoker.isInCombat()) || (!mob.isInCombat()) || (!msg.source().isInCombat()))
