...
import com.planet_ink.game.core.collections.WeakArrayList;
import com.planet_ink.game.core.interfaces.Environmental;
import com.planet_ink.game.core.interfaces.Physical;
import com.planet_ink.game.core.interfaces.Rider;
...
public class PlanarAbility extends StdAbility {
        ...
        try {
            ...
            for (Enumeration<Item> i = room.items(); i.hasMoreElements(); ) {
                ...
                if ((I instanceof Exit) && ((I instanceof BoardableShip))) {
                    ...
                    I.setReadableText("");
                else if ((invoker != null) && ((I instanceof Weapon) || (I instanceof Armor))) {
                ...
                if ((M != null)
                    ...
                    if ((planarPrefix != null) && (planarPrefix.length() > 0)) {
                        ...
                        if (oldName.toLowerCase().indexOf(planarPrefix.toLowerCase()) < 0) {
                            ...
                            } else if (CMLib.english().startsWithAnArticle(M.displayText())) {
                            ...
                            } else if ((x = M.displayText().toLowerCase().indexOf(M.charStats().getMyRace().name().toLowerCase())) >= 0) {
            ...
            case CMMsg.TYP_DAMAGE:
                if ((msg.tool() instanceof Weapon)
                    ...
                    if ((CMLib.flags().isABonusItems((Weapon) msg.tool()) && (this.reqWeapons.contains("MAGICAL")))
                        ...
                        || (this.reqWeapons.contains(Weapon.TYPE_DESCS[((Weapon) msg.tool()).weaponDamageType()]))) { // pass
                    } else
                        msg.setValue(0);
                }
                break;
    ...
    public boolean invoke(MOB mob, List<String> commands, Physical givenTarget, boolean auto, int asLevel) {
        ...
        } else if (proficiencyCheck(mob, -95, auto)) {
            // kaplah!
        } else if (proficiencyCheck(mob, -50, auto)) {
            if (proficiency() < 75) {
                randomTransitionPlane = true;
                randomArea = true;
            } else if (proficiency() < 100) {
