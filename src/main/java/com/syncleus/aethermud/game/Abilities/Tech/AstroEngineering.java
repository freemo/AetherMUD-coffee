 ...
 */
package com.syncleus.aethermud.game.Abilities.Tech;
...
public class AstroEngineering extends TechSkill {
    ...
    public boolean tick(Tickable ticking, int tickID) {
        if ((affected instanceof MOB) && (tickID == Tickable.TICKID_MOB)) {
            ...
            } else if (((baseTickSpan - tickDown) % 4) == 0) {
    ...
    public boolean invoke(MOB mob, List<String> commands, Physical givenTarget, boolean auto, int asLevel) {
        ...
        } else if ("REPAIR".startsWith((commands.get(0)).toUpperCase())) {
            op = Operation.REPAIR;
            commands.remove(0);
        } else if ("ENHANCE".startsWith((commands.get(0)).toUpperCase())) {
