...
public class Bomb_Explosive extends StdBomb {
    ...
    public void spring(MOB target) {
        if (target.location() != null) {
            ...
            else if (target.location().show(invoker(), target, this, CMMsg.MASK_ALWAYS | CMMsg.MSG_NOISE, (affected.name() + " explodes all over <T-NAME>!") + CMLib.protocol().msp("explode.wav", 30))) {
                super.spring(target);
