...
import com.planet_ink.game.Abilities.interfaces.HealthCondition;
...
public class Amputation extends StdAbility implements LimbDamage, HealthCondition {
    ...
    public void affectCharState(MOB affected, CharState affectableState) {
        ...
        } else if (amputations[Race.BODY_FOOT] < 0) {
    ...
    public MOB getTarget(MOB mob, List<String> commands, Environmental givenTarget, boolean quiet) {
        ...
        else if ((targetName.length() == 0) && (mob.isInCombat()) && (abstractQuality() == Ability.QUALITY_MALICIOUS) && (mob.getVictim() != null))
    ...
    public List<String> unaffectedLimbSet() {
        ...
        for (int i = 0; i < limbs.length; i++) {
            ...
            if ((limbs[i] > 0)
                ...
                } else if (limbs[i] - amputations[i] == 2) {
...
// ****************************************************************************
    ...
    public void restoreLimb(String gone) {
        if (affected != null) {
            ...
            } else if ((affected instanceof DeadBody)
