        ...
        if (success) {
            ...
            if (mob.location().okMessage(mob, msg)) {
                ...
                if ((LB != null) && (AO != null)) {
                    ...
                    else if (LB.isAnyOfficer(AO, target))
                ...
                else if (target.charStats().getStat(CharStats.STAT_INTELLIGENCE) >= 13)
                    adjective += "very intelligent, ";
                else if (target.charStats().getStat(CharStats.STAT_INTELLIGENCE) > 10)
                    adjective += "intelligent, ";
                else if (target.charStats().getStat(CharStats.STAT_INTELLIGENCE) <= 3)
                    adjective += "instinctual, ";
                else if (target.charStats().getStat(CharStats.STAT_INTELLIGENCE) < 7)
                    adjective += "stupid, ";
                else if (target.charStats().getStat(CharStats.STAT_INTELLIGENCE) < 10)
                ...
                else if (target.charStats().getStat(CharStats.STAT_WISDOM) >= 13)
                    adjective += "very wise, ";
                else if (target.charStats().getStat(CharStats.STAT_WISDOM) > 10)
                    adjective += "wise, ";
                else if (target.charStats().getStat(CharStats.STAT_WISDOM) <= 3)
                    adjective += "extremely naieve, ";
                else if (target.charStats().getStat(CharStats.STAT_WISDOM) < 7)
                    adjective += "naieve, ";
                else if (target.charStats().getStat(CharStats.STAT_WISDOM) < 10)
                    adjective += "unwise, ";
