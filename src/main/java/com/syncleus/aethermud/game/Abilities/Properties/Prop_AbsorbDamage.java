        ...
        if ((affected != null)
            ...
            if (absorb != null) {
                if (((msg.targetMinor() == CMMsg.TYP_DAMAGE) || (msg.targetMinor() == CMMsg.TYP_HEALING)) && (msg.value() > 0)) {
                    ...
                    if (msg.value() < 0)
                        msg.setValue(0);
                } else if ((enhFlag) && (absorb instanceof Double)) {
                    ...
                    } else if (CMLib.dice().rollPercentage() < (((Double) absorb).doubleValue() * 100.0)) {
