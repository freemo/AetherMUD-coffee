...
import com.syncleus.aethermud.game.WebMacros.grinder.*;
...
public class MUDGrinder extends StdWebMacro {
        ...
        if (ID.startsWith("ITEM#<") && (ID.endsWith(">"))) {
            ...
            while (x >= 0) {
                ...
                if (x >= 0) {
                    ...
                    else if (thing.startsWith("I=") && (x > 2))
                        itemCode = thing.substring(2);
                    else if (thing.startsWith("R=") && (x > 2))
                        roomCode = thing.substring(2);
                    else if (thing.startsWith("M=") && (x > 2))
            ...
            synchronized (sync.intern()) {
                ...
                if ((playerM != null) && (R == null)) {
                    ...
                    M = playerM;
                } else if ((mobCode != null) && (mobCode.length() > 0)) {
                    if (R != null)
    ...
    public String runMacro(HTTPRequest httpReq, String parm, HTTPResponse httpResp) {
        ...
        if (parms != null)
            if (parms.containsKey("AREAMAP")) {
            ...
            } else if (parms.containsKey("AREATHUMBNAIL")) {
                try {
                    final String AREA = httpReq.getUrlParameter("AREA");
                    final Area A = getAreaObject(AREA);
                    if (A == null) return "";
            ...
            } else if (parms.containsKey("WORLDMAP")) {
                GrinderFlatMap map = null;
                if ((httpReq.getUrlParameter("MAPSTYLE") != null)
                    && (httpReq.getUrlParameter("MAPSTYLE").length() > 0))
                    map = new GrinderMap();
                ...
                map.rePlaceRooms();
                return map.getHTMLMap(httpReq).toString();
            } else if (parms.containsKey("AREALIST")) {
            ...
            } else if (parms.containsKey("PLANETLIST")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final Area pickedA = getLoggedArea(httpReq, mob);
            ...
            } else if (parms.containsKey("ISSPACE")) {
                return "" + CMLib.map().spaceAreas().hasMoreElements();
            } else if (parms.containsKey("DELAREA")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
            ...
            } else if (parms.containsKey("EDITACCOUNT")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                ...
                return "";
            } else if (parms.containsKey("DELACCOUNT")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final String last = httpReq.getUrlParameter("ACCOUNT");
                ...
                return "";
            } else if (parms.containsKey("DELCATALOGMOB")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                ...
                return "@break@";
            } else if (parms.containsKey("DELCATALOGITEM")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                ...
                return "@break@";
            } else if (parms.containsKey("DELCOMPONENT")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
            ...
            } else if (parms.containsKey("EDITCOMPONENT") || parms.containsKey("ADDCOMPONENT")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final String last = httpReq.getUrlParameter("COMPONENT");
            ...
            } else if (parms.containsKey("DELALLQUALIFY")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
            ...
            } else if (parms.containsKey("EDITALLQUALIFY") || parms.containsKey("ADDALLQUALIFY")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final String last = httpReq.getUrlParameter("ALLQUALID");
            ...
            } else if (parms.containsKey("DELCLAN")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
            ...
            } else if (parms.containsKey("EDITCLAN")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final String last = httpReq.getUrlParameter("CLAN");
            ...
            } else if (parms.containsKey("ADDCLAN")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
            ...
            } else if (parms.containsKey("DELCLANGOVERNMENT")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
            ...
            } else if (parms.containsKey("EDITCLANGOVERNMENT")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final String last = httpReq.getUrlParameter("GOVERNMENT");
            ...
            } else if (parms.containsKey("IMPORTAREA")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                byte[] bufBytes = null;
            ...
            } else if (parms.containsKey("ADDAREA")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                ...
                return "true";
            } else if (parms.containsKey("EDITAREA")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                String AREA = httpReq.getUrlParameter("AREA");
                final Area A = getAreaObject(AREA);
                if (A == null)
            ...
            } else if (parms.containsKey("DELEXIT")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
            ...
            } else if (parms.containsKey("EDITEXIT")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final Room R = getRoomObject(httpReq, httpReq.getUrlParameter("ROOM"));
                ...
                httpReq.addFakeUrlParameter("ERRMSG", errMsg);
            } else if (parms.containsKey("QUICKFIND")) {
                ...
                return "";
            } else if (parms.containsKey("LINKEXIT")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final Room R = getRoomObject(httpReq, httpReq.getUrlParameter("ROOM"));
                ...
                httpReq.addFakeUrlParameter("ERRMSG", errMsg);
            } else if (parms.containsKey("LINKAREA")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final Room R = getRoomObject(httpReq, httpReq.getUrlParameter("ROOM"));
                ...
                httpReq.addFakeUrlParameter("ERRMSG", errMsg);
            } else if (parms.containsKey("EDITROOM")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                ...
                httpReq.addFakeUrlParameter("ERRMSG", errMsg);
            } else if (parms.containsKey("DELHOLIDAY")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
            ...
            } else if (parms.containsKey("EDITHOLIDAY")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final String last = httpReq.getUrlParameter("HOLIDAY");
            ...
            } else if (parms.containsKey("DELRACE")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                Race R = null;
            ...
            } else if (parms.containsKey("EDITRACE")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                Race R = null;
            ...
            } else if (parms.containsKey("DELCLASS")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                CharClass C = null;
            ...
            } else if (parms.containsKey("EDITCLASS")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                CharClass C = null;
            ...
            } else if (parms.containsKey("DELFACTION")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                Faction F = null;
            ...
            } else if (parms.containsKey("EDITFACTION")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                Faction F = null;
                ...
                return errMsg;
            } else if (parms.containsKey("DELABILITY")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                Ability A = null;
            ...
            } else if (parms.containsKey("EDITABILITY")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                Ability A = null;
            ...
            } else if (parms.containsKey("EDITITEM")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                ...
                httpReq.addFakeUrlParameter("ERRMSG", errMsg);
            } else if (parms.containsKey("EDITMOB")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final String roomID = httpReq.getUrlParameter("ROOM");
                ...
                httpReq.addFakeUrlParameter("ERRMSG", errMsg);
            } else if (parms.containsKey("EDITPLAYER")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                ...
                httpReq.addFakeUrlParameter("ERRMSG", errMsg);
            } else if (parms.containsKey("DELROOM")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final String multiFlagStr = httpReq.getUrlParameter("MULTIROOMFLAG");
            ...
            } else if (parms.containsKey("RESETROOM")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final String multiFlagStr = httpReq.getUrlParameter("MULTIROOMFLAG");
                ...
                httpReq.addFakeUrlParameter("ERRMSG", errMsg);
            } else if (parms.containsKey("ADDROOM")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                ...
                httpReq.addFakeUrlParameter("LINK", "");
            } else if (parms.containsKey("MASSACCOUNTCREATE")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
            ...
            } else if (parms.containsKey("PAINTROOMS")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final String AREA = httpReq.getUrlParameter("AREA");
            ...
            } else if (parms.containsKey("ADDGRIDROOM")) {
                final MOB mob = Authenticate.getAuthenticatedMob(httpReq);
                if (mob == null)
                    return "@break@";
                final String AREA = httpReq.getUrlParameter("AREA");
