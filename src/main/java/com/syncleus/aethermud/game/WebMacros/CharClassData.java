            ...
            if (C != null) {
                                    ...
                                    if (nameSet.size() == 0)
                                        ...
                                        for (int n = 0; n < nameSet.size(); n++) {
                                            if (minLevel < ((Integer) nameSet.elementAt(n, 1)).intValue()) {
                                                ...
                                                added = true;
                                                break;
                                            } else if (minLevel == ((Integer) nameSet.elementAt(n, 1)).intValue()) {
                                                added = true;
                                                break;
                                            }
                                        }
                ...
                if (parms.containsKey("ESTATS") || parms.containsKey("CSTATS") || parms.containsKey("ASTATS") || parms.containsKey("ASTATE") || parms.containsKey("STARTASTATE")) {
                    ...
                    if (parms.containsKey("CSTATS")) {
                        final CharStats setStats = (CharStats) CMClass.getCommon("DefaultCharStats");
                    ...
                    if (parms.containsKey("ASTATS")) {
                        final CharStats adjStats = (CharStats) CMClass.getCommon("DefaultCharStats");
                    ...
                    if (parms.containsKey("ASTATE")) {
                        final CharState adjState = (CharState) CMClass.getCommon("DefaultCharState");
                    ...
                    if (parms.containsKey("STARTASTATE")) {
                        final CharState startAdjState = (CharState) CMClass.getCommon("DefaultCharState");
                                ...
                                if (sSet.size() == 0)
                                    ...
                                    for (int n = 0; n < sSet.size(); n++) {
                                        if (minLevel < ((Integer) sSet.elementAt(n, 1)).intValue()) {
                                            ...
                                            added = true;
                                            break;
                                        } else if (minLevel == ((Integer) sSet.elementAt(n, 1)).intValue()) {
                                            added = true;
                                            break;
                                        }
                                    }
        ...
        for (int l = 1; l <= levelCap; l++) {
            ...
            for (int s = 0; s < set.size(); s++) {
                ...
                if ((numOthers == 0) && (numOutsiders == 0)) {
                    ...
                    else if ((A != null) && (A.flags() & (Ability.FLAG_HOLY + Ability.FLAG_UNHOLY)) == (Ability.FLAG_HOLY))
                        uniqueClassSkillsV.add(able + "(" + l + ")G");
                    else if ((A != null) && (A.flags() & (Ability.FLAG_HOLY + Ability.FLAG_UNHOLY)) == (Ability.FLAG_UNHOLY))
                        uniqueClassSkillsV.add(able + "(" + l + ")E");
                    else
                        uniqueClassSkillsV.add(able + "(" + l + ")");
                } else if (numOutsiders == 0) {
                    uncommonClassSkills++;
                    if ((A != null) && (A.flags() & (Ability.FLAG_HOLY + Ability.FLAG_UNHOLY)) == (Ability.FLAG_HOLY + Ability.FLAG_UNHOLY))
