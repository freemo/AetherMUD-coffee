...
import com.syncleus.aethermud.game.WebMacros.grinder.GrinderMobs.MOBDataField;
            ...
            if (M == null) {
                if (mobCode.startsWith("CATALOG-") || mobCode.startsWith("NEWCATA-")) {
                    ...
                    if (M == null)
                        ...
                        M = (MOB) M.copyOf();
                } else if (mobCode.equals("NEW"))
                    M = CMClass.getMOB("GenMob");
                else if (mobCode.equals("NEWDEITY")) {
            ...
            if (parms.containsKey(parmName)) {
                ...
                switch (o) {
                    ...
                    case GENDER: // gender
                        ...
                        } else if (old.toUpperCase().startsWith("F")) {
