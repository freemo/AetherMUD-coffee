            ...
            if (C != null) {
                ...
                if (parms.containsKey("MEMBERSTART")) {
                    ...
                    if (parms.containsKey("SORTBY")) {
                        ...
                        } else if (sort.equalsIgnoreCase("KILLS") || sort.equalsIgnoreCase("TOTALKILLS")) {
                            Collections.sort(members, new Comparator<MemberRecord>() {
                                @Override
                                public int compare(MemberRecord o1, MemberRecord o2) {
                        ...
                        } else if (sort.equalsIgnoreCase("MOBKILLS")) {
                            Collections.sort(members, new Comparator<MemberRecord>() {
                                @Override
                                public int compare(MemberRecord o1, MemberRecord o2) {
                        ...
                        } else if (sort.equalsIgnoreCase("PLAYERKILLS") || sort.equalsIgnoreCase("PVPKILLS")) {
                            Collections.sort(members, new Comparator<MemberRecord>() {
                                @Override
                                public int compare(MemberRecord o1, MemberRecord o2) {
