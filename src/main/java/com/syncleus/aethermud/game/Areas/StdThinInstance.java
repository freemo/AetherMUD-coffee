...
import com.syncleus.aethermud.game.Libraries.interfaces.TrackingLibrary.RFilter;
import com.syncleus.aethermud.game.Libraries.interfaces.TrackingLibrary.RFilters;
...
public class StdThinInstance extends StdThinArea {
    ...
    public void executeMsg(final Environmental myHost, final CMMsg msg) {
        ...
        if (CMath.bset(flags(), Area.FLAG_INSTANCE_CHILD)) {
            ...
            } else if ((msg.sourceMinor() == CMMsg.TYP_QUIT) && (CMLib.map().isHere(msg.source(), this))) {
