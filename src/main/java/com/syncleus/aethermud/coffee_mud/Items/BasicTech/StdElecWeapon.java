...
public class StdElecWeapon extends StdElecItem implements Weapon, Electronics {
    ...
    public void executeMsg(final Environmental myHost, final CMMsg msg) {
        ...
        } else if ((owner() instanceof MOB) && msg.amISource((MOB) owner()) && (!amWearingAt(Wearable.IN_INVENTORY))) {
            super.executeMsg(myHost, msg);
                        ...
                        switch (mode) {
                            case STUN: {
                                if (msg.value() > 0) {
                                    ...
                                    else if ((A == null) && (msg.target() instanceof MOB)) {
