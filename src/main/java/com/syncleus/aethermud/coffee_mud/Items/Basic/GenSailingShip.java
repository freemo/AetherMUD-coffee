...
import com.planet_ink.coffee_mud.core.collections.SPairList;
...
public class GenSailingShip extends StdBoardable implements SailingShip {
    ...
    public boolean okMessage(final Environmental myHost, final CMMsg msg) {
        ...
        if ((msg.target() == this)
            ...
            if (anchorDown)
                return false;
        } else if ((msg.sourceMinor() == CMMsg.TYP_HUH)
        ...
        } else if ((msg.sourceMinor() == CMMsg.TYP_COMMAND)
            ...
            if (ticksSinceMove < 2) {
                ...
                msg.source().tell(CMLib.lang().L("You'll need some assistance to board a ship from the water."));
                return false;
            } else if (!CMLib.flags().isClimbing(msg.source())) {
        ...
        } else if ((msg.sourceMinor() == CMMsg.TYP_COMMANDFAIL)
            && (msg.targetMessage() != null)
        ...
        } else if ((msg.targetMinor() == CMMsg.TYP_LEAVE)
    ...
    public void executeMsg(final Environmental myHost, final CMMsg msg) {
        ...
        if (msg.target() == this) {
            switch (msg.targetMinor()) {
                ...
                case CMMsg.TYP_EXAMINE: {
                    ...
                    else if ((this.courseDirection >= 0)
        ...
        } else if (msg.target() instanceof AmmunitionWeapon) {
            switch (msg.targetMinor()) {
    ...
    public long expirationDate() {
        ...
        if (R == null)
            dispossessionTime = 0;
        else if (CMLib.flags().isUnderWateryRoom(R)) {
    ...
    public void setCombatant(PhysicalAgent other) {
        ...
        if (other == null)
            clearTacticalMode();
        else if (CMLib.flags().isDeepWaterySurfaceRoom(R)) {
            targetedShip = other;
            if (R != null)
                shipCombatRoom = R;
