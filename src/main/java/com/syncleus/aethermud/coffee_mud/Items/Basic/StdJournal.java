...
public class StdJournal extends StdItem {
    ...
    public void executeMsg(final Environmental myHost, final CMMsg msg) {
                    ...
                    if (!CMLib.flags().canBeSeenBy(this, mob))
                        ...
                        for (int v = 0; v < parse.size(); v++) {
                            ...
                            if (CMath.s_long(s) > 0)
                                ...
                                newOnly = true;
                            else if (s.equalsIgnoreCase("ALL") || s.equalsIgnoreCase("OLD"))
                                all = true;
                        }
                                    ...
                                    try {
                                        ...
                                        if (s.equalsIgnoreCase("S"))
                                            ...
                                            if ((M == null) || (M.playerStats() == null) || (M.playerStats().getEmail().indexOf('@') < 0)) {
                                                ...
                                                repeat = true;
                                            } else if (!mob.session().choose(L("Send email to @x1 (Y/n)?", M.Name()), L("YN\n"), "Y").equalsIgnoreCase("N")) {
                        ...
                        if ((msg.targetMessage().toUpperCase().startsWith("DEL"))
                            ...
                            if (msg.targetMessage().length() > 1) {
                                ...
                                if (CMath.s_bool(getParm("PRIVATE")))
                                    to = mob.Name();
                                else if (CMath.s_bool(getParm("MAILBOX"))
        ...
        } else if (((msg.targetMinor() == CMMsg.TYP_LOOK) || (msg.targetMinor() == CMMsg.TYP_EXAMINE))
