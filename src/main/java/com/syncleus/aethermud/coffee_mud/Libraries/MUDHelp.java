...
import com.planet_ink.coffee_mud.Libraries.interfaces.HelpLibrary;
...
public class MUDHelp extends StdLibrary implements HelpLibrary {
    ...
    public String getAbilityTargetDesc(Ability A) {
        ...
        else if ((CMClass.basicItems().hasMoreElements())
        ...
        } else if (A.abstractQuality() == Ability.QUALITY_INDIFFERENT)
            prepend.append(L("Items or Rooms"));
        else if (A.abstractQuality() == Ability.QUALITY_MALICIOUS)
            prepend.append(L("Others"));
        else if ((A.abstractQuality() == Ability.QUALITY_BENEFICIAL_OTHERS)
            || (A.abstractQuality() == Ability.QUALITY_OK_SELF))
    ...
    public String fixHelp(String tag, String str, MOB forMOB) {
        ...
        if (str.startsWith("<CURRENCY>") || worldCurrency) {
            ...
            help.append(str);
            str = help.toString();
        } else if (str.startsWith("<EXPERTISE>")) {
        ...
        if (str.startsWith("<ABILITY>")) {
            ...
            } else if (name.startsWith("CHANT_")) {
