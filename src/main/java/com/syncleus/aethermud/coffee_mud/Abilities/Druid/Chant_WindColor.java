        ...
        for (int i = 0; i < R.numItems(); i++) {
            ...
            if (I != null) {
                ...
                if (I.phyStats().level() >= (mob.phyStats().level() + 25))
                    levelCode = 4;
                else if (I.phyStats().level() >= (mob.phyStats().level() + 15)) {
                    if (levelCode < 3)
                        levelCode = 3;
                } else if (I.phyStats().level() >= (mob.phyStats().level() + 5)) {
                    if (levelCode < 2)
                        levelCode = 2;
                } else if (I.phyStats().level() > (mob.phyStats().level() - 5)) {
                    if (levelCode < 1)
        ...
        for (int i = 0; i < R.numInhabitants(); i++) {
            ...
            if ((M != null) && (M != mob) && (!group.contains(M))) {
                ...
                if (M.phyStats().level() >= (mob.phyStats().level() + 25))
                    levelCode = 4;
                else if (M.phyStats().level() >= (mob.phyStats().level() + 15)) {
                    if (levelCode < 3)
                        levelCode = 3;
                } else if (M.phyStats().level() >= (mob.phyStats().level() + 5)) {
                    if (levelCode < 2)
                        levelCode = 2;
                } else if (M.phyStats().level() > (mob.phyStats().level() - 5)) {
                    if (levelCode < 1)
                ...
                if (CMLib.flags().isGood(M))
                    colors[2]++;
                else if (CMLib.flags().isEvil(M))
                    colors[1]++;
                else if ((!CMLib.flags().isGood(M)) && (!CMLib.flags().isEvil(M)))
                    colors[3]++;
            }
        }
        if (colors == null)
