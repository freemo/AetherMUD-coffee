...
public class Skill_Disguise extends BardSkill {
    ...
    public void affectPhyStats(Physical myHost, PhyStats affectableStats) {
        ...
        if (values[7] != null)
            ...
            else if (values[7].equalsIgnoreCase("evil"))
        ...
        switch (which) {
            ...
            case 2: // sex
                if (how.toUpperCase().startsWith("M"))
                    how = "male";
                else if (how.toUpperCase().startsWith("F"))
                    how = "female";
                else if (how.toUpperCase().startsWith("N"))
                    how = "neuter";
                else if (how.toUpperCase().startsWith("B"))
                    how = "male";
                else if (how.toUpperCase().startsWith("G"))
                    how = "girl";
                else {
