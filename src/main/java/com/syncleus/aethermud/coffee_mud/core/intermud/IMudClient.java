...
import com.planet_ink.coffee_mud.Libraries.interfaces.I3Interface;
...
import com.planet_ink.coffee_mud.core.intermud.imc2.IMC_CHANNEL;
import com.planet_ink.coffee_mud.core.intermud.imc2.REMOTEINFO;
...
public class IMudClient implements I3Interface {
    ...
    public void i3who(MOB mob, String mudName) {
        ...
        } else if (imc2online() && (imc2.getIMC2Mud(mudName) != null))
    ...
    public void i3channel(MOB mob, String channelName, String message) {
        ...
        } else if (imc2online() && (imc2.getAnIMC2Channel(channelName) != null)) {
            int emote = 0;
            if ((message.startsWith(":") || message.startsWith(",")) && (message.trim().length() > 1)) {
        ...
        while (e.hasMoreElements()) {
            ...
            if (r != null) {
                ...
                if (r.policy == IMC2Driver.CHAN_PRIVATE)
                    policy = "(private)";
                else if (r.policy == IMC2Driver.CHAN_COPEN)
                    policy = "open";
                else if (r.policy == IMC2Driver.CHAN_CPRIVATE)
                    policy = "(cprivate)";
