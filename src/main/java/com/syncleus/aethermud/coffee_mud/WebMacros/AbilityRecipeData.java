    ...
    public String runMacro(HTTPRequest httpReq, String parm, HTTPResponse httpResp) {
        ...
        if (last.length() > 0) {
            ...
            if ((A != null)
                ...
                if (parms.containsKey("SAVETOVFS")) {
                ...
                } else if (parms.containsKey("ROWTABLE") && (CMath.isInteger(rownum))) {
                ...
                } else if (parms.containsKey("ADDROW")) {
                ...
                } else if (parms.containsKey("SAVEROW") && (CMath.isInteger(rownum))) {
                    DVector dataRow = null;
                    final int row = CMath.s_int(rownum);
                    ...
                    if (CMSecurity.isAllowedAnywhere(M, CMSecurity.SecFlag.CMDRECIPES))
                        ...
                        return " @break@";
                } else if (parms.containsKey("DELROW") && (CMath.isInteger(rownum))) {
                    final int row = CMath.s_int(rownum);
                    if ((row - 1 >= 0) && (row - 1 < recipeData.dataRows().size()))
                    ...
                    if (CMSecurity.isAllowedAnywhere(M, CMSecurity.SecFlag.CMDRECIPES))
                        ...
                        return " @break@";
                } else if (parms.containsKey("TABLE")) {
                    str.append("\n\r<TABLE WIDTH=100% BORDER=1 CELLSPACING=0 CELLPADDING=0>");
                    //int currLenTotal = 0;
