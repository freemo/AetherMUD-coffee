...
public class ControlPanel extends StdWebMacro {
    ...
    public String runMacro(HTTPRequest httpReq, String parm, HTTPResponse httpResp) {
        ...
        if (query.equalsIgnoreCase("DISABLE")) {
            ...
            //}
            return "";
        } else if (query.equalsIgnoreCase("DEBUG")) {
            final String field = parms.get("FIELD");
            if ((field == null) || (field.length() == 0))
                return "";
            ...
            if ((flag != null) && (CMSecurity.isDebugging(flag)))
                return " CHECKED ";
            return "";
        } else if (query.equalsIgnoreCase("CHANGEDISABLE")) {
            final String field = parms.get("FIELD");
            if ((field == null) || (field.length() == 0))
                return "";
            ...
            return "";
        } else if (query.equalsIgnoreCase("CHANGEENABLE")) {
            final String field = parms.get("FIELD");
            if ((field == null) || (field.length() == 0))
                return "";
            final String value = parms.get("VALUE");
            ...
            return "";
        } else if (query.equalsIgnoreCase("CHANGEDEBUG")) {
            final String field = parms.get("FIELD");
            if ((field == null) || (field.length() == 0))
                return "";
            final String value = parms.get("VALUE");
            ...
            } else if (field.equalsIgnoreCase("SAVETHREAD")) {
