    ...
    public class FakeCondition {
        ...
        public boolean compareValue(ComparableValue subKey) {
            ...
            if (like && conditionValue.getValue() instanceof String) {
                ...
                if (lowStr.length() == 0)
                ...
                else if (subKey.equals(null) || (!(subKey.getValue() instanceof String)))
                    chk = false;
                else {
                    ...
                    } else if (lowStr.charAt(lowStr.length() - 1) == '%')
