...
public class DirtyLanguage extends StdLibrary implements LanguageLibrary {
    ...
    protected Hashtable<String, DVector> loadFileSections(String filename) {
        ...
        for (int v = 0; v < V.size(); v++) {
            ...
            if (s.startsWith("[")) {
            ...
            } else if (s.toUpperCase().startsWith("AUTOIGNORE")) {
            ...
            } else if (s.toUpperCase().startsWith("DEFINE")) {
            ...
            } else if (s.toUpperCase().startsWith("IGNOREWHOLE")) {
            ...
            } else if (s.toUpperCase().startsWith("REPLACEWHOLE") || s.toUpperCase().startsWith("REPLACEEXACT")) {
                int regstart = s.indexOf('"');
                if (regstart < 0) {
                    Log.errOut("Scripts", "Syntax error in '" + filename + "', line " + (v + 1));
                    continue;
            ...
            } else if (s.toUpperCase().startsWith("REPLACEALL")) {
                ...
                currentSectionReplaceStrs.put(expression.toLowerCase(), replacement);
            } else if (s.toUpperCase().startsWith("REPLACE") || s.toUpperCase().startsWith("IGNORE")) {
