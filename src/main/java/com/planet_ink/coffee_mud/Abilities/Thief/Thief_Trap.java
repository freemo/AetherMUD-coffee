    ...
    public boolean invoke(MOB mob, List<String> commands, Physical givenTarget, boolean auto, int asLevel) {
        ...
        if (trapThis != null) {
            ...
            for (int r = 0; r < traps.size(); r++) {
                ...
                else if (T.canAffect(Ability.CAN_EXITS))
                    buf.append(CMStrings.padRight(L("Exits, Containers"), 17) + " ");
                else if (T.canAffect(Ability.CAN_ITEMS))
        ...
        if (theOldTrap != null) {
            ...
            } else if ((theOldTrap.invoker() == mob)
                && (theTrap != null)
                && (theOldTrap.ID().equals(theTrap.ID()))
        ...
        if (mob.location().okMessage(mob, msg)) {
            ...
            if (success) {
                ...
                if ((trapThis instanceof Room)
                    ...
                    permanent = true;
                else if (trapThis instanceof Exit) {
