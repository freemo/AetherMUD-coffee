...
public class Reset extends StdCommand {
    ...
    public String resetWarning(MOB mob, Room R) {
        ...
        for (int i = 0; i < R.numItems(); i++) {
            ...
            else if ((I instanceof PrivateProperty)
    ...
    public boolean execute(MOB mob, List<String> commands, int metaFlags)
        ...
        if (s.equalsIgnoreCase("rejuv")) {
        ...
        } else if (s.equalsIgnoreCase("relevel")) {
            ...
            if ((sess == null)
                ...
                for (final Enumeration<String> r = A.getProperRoomnumbers().getRoomIDs(); r.hasMoreElements(); ) {
                    ...
                    if ((R != null) && (R.roomID() != null) && (R.roomID().length() > 0)) {
                        ...
                        } else if (CMLib.percolator().relevelRoom(room, oldMinLevel, oldMaxLevel, levelLow, levelHigh)) {
        ...
        } else if (s.equalsIgnoreCase("sorthelp")) {
            ...
            } else if (rest.toLowerCase().startsWith("yesprompt ")) {
            ...
            for (final helpSets help : sets) {
                ...
                for (Enumeration<Ability> e = CMClass.abilities(); e.hasMoreElements(); ) {
                    ...
                    if (help.filter.passesFilter(A)) {
                        ...
                        } else if ((bup[0] != null) && (bup[1] != null) && (bup[0] != bup[1])) {
            ...
            } else if ((mob.session() == null) || (mob.session().confirm(L("Would you like to set the password for '@x1' to '@x2' (Y/n)?", finalName, finalName.toLowerCase()), "Y"))) {
        ...
        } else if (CMLib.players().getPlayer(s) != null) {
        ...
        } else if (s.equalsIgnoreCase("roomids") && (CMSecurity.isAllowed(mob, mob.location(), CMSecurity.SecFlag.CMDROOMS))) {
            final Area A = mob.location().getArea();
        ...
        } else if (s.equalsIgnoreCase("arearoomids") && (CMSecurity.isAllowed(mob, mob.location(), CMSecurity.SecFlag.CMDROOMS))) {
            final Area A = mob.location().getArea();
            boolean somethingDone = false;
            for (final Enumeration e = A.getCompleteMap(); e.hasMoreElements(); ) {
                Room R = (Room) e.nextElement();
            ...
            if (!somethingDone)
                ...
                mob.tell(L("Done renumbering rooms."));
        } else if (!CMSecurity.isAllowed(mob, mob.location(), CMSecurity.SecFlag.RESETUTILS)) {
            mob.tell(L("'@x1' is an unknown reset.  Try ROOM, AREA, AREAROOMIDS *.\n\r * = Reset functions which may take a long time to complete.", s));
            return false;
        } else if (s.equalsIgnoreCase("propertygarbage")) {
        ...
        } else if (s.equalsIgnoreCase("racestatgains") && (CMSecurity.isAllowed(mob, mob.location(), CMSecurity.SecFlag.CMDRACES))) {
        ...
        } else if (s.equalsIgnoreCase("genraceagingcharts") && (CMSecurity.isAllowed(mob, mob.location(), CMSecurity.SecFlag.CMDRACES))) {
        ...
        } else if (s.equalsIgnoreCase("genmixedracebuilds") && (CMSecurity.isAllowed(mob, mob.location(), CMSecurity.SecFlag.CMDRACES))) {
        ...
        } else if (s.equalsIgnoreCase("bankdata") && (CMSecurity.isASysOp(mob))) {
        ...
        } else if (s.equalsIgnoreCase("mobstats") && (CMSecurity.isASysOp(mob))) {
            s = "room";
            if (commands.size() > 1)
                s = commands.get(1);
            if (mob.session() == null)
            ...
            if (mob.session().confirm(L("Alter every mobs combat stats to system defaults?!"), L("N"))) {
                ...
                } else if (s.toUpperCase().startsWith("CATALOG")) {
                    try {
                ...
                } else if (s.toUpperCase().startsWith("WORLD")) {
                    try {
        ...
        } else if (s.equalsIgnoreCase("groundlydoors") && (CMSecurity.isASysOp(mob))) {
            if (mob.session() == null)
                return false;
        ...
        } else if (s.equalsIgnoreCase("allmobarmorfix") && (CMSecurity.isASysOp(mob))) {
            if (mob.session() == null)
                return false;
        ...
        } else if (s.equalsIgnoreCase("goldceilingfixer") && (CMSecurity.isASysOp(mob))) {
            if (mob.session() == null)
                return false;
        ...
        } else if (s.equalsIgnoreCase("areainstall") && (CMSecurity.isASysOp(mob))) {
            if (mob.session() == null)
                return false;
            if (commands.size() < 2) {
                ...
                for (final Enumeration<Area> a = CMLib.map().areas(); a.hasMoreElements(); ) {
                    ...
                    if ((O instanceof Behavior)) {
                        ...
                        if (B == null) {
                            ...
                            A.addBehavior(B);
                            changed = true;
                        } else if (!B.getParms().equals(CMParms.combine(commands, 2))) {
                            B.setParms(CMParms.combine(commands, 2));
                            changed = true;
                        }
                        ...
                        if (B == null) {
                            ...
                            changed = true;
                        } else if (!B.text().equals(CMParms.combine(commands, 2))) {
                            B.setMiscText(CMParms.combine(commands, 2));
                            changed = true;
                        }
                    }
        ...
        } else if (s.equalsIgnoreCase("worldmatconfirm") && (CMSecurity.isASysOp(mob))) {
            if (mob.session() == null)
                return false;
        ...
        } else if (s.equalsIgnoreCase("mixedraces") && (CMSecurity.isASysOp(mob))) {
                        ...
                        if (R1 != null) {
                            if (!R1.isGeneric())
                                ...
                                if (lastPart.equals("Whelpling"))
                                    races.add(R1);
                                else if (!lastPart.endsWith("ling"))
                                    races.add(R1);
                                else if (CMClass.findRace(lastPart.substring(0, lastPart.length() - 4)) != null)
                                    races.add(R1);
                                else
        ...
        } else if (s.equalsIgnoreCase("itemstats") && (CMSecurity.isASysOp(mob))) {
            s = "room";
            if (commands.size() > 1)
                s = commands.get(1);
        ...
        } else if (s.equalsIgnoreCase("VISITATION")) {
            try {
                if (commands.size() > 1)
                    s = commands.get(1);
                boolean area = false;
        ...
        } else if (s.equalsIgnoreCase("arearacemat") && (CMSecurity.isASysOp(mob))) {
        ...
        } else if (s.equalsIgnoreCase("manufacturers")) {
            TechType[] types;
            String[] names;
