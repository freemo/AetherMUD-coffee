...
public class WillQualify extends Skills {
    ...
    public StringBuffer getQualifiedAbilities(MOB viewerM,
        ...
        for (int l = 0; l <= highestLevel; l++) {
            ...
            @SuppressWarnings("unchecked")            final Enumeration<AbilityMapper.AbilityMapping> emur = new MultiEnumeration<AbilityMapper.AbilityMapping>(
                new Enumeration[]
                    {
    ...
    public boolean execute(MOB mob, List<String> commands, int metaFlags)
        ...
        while (commands.size() > 0) {
            ...
            if ((CMLib.expertises().findDefinition(str, false) != null)
                ...
                continue;
            } else if ((CMLib.expertises().findDefinition(bothStr, false) != null)) {
                commands.remove(0);
                commands.remove(0);
