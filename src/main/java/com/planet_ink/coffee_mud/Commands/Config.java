        ...
        if ((commands != null) && (commands.size() > 1)) {
            ...
            if (finalA == null) {
                if (name.equalsIgnoreCase("LINEWRAP")) {
                    ...
                    else if ("DISABLED".startsWith(newWrap.toUpperCase()) && (newWrap.length() > 0))
                        newVal = 0;
                    else {
                ...
                } else if (name.equalsIgnoreCase("PAGEBREAK")) {
                    ...
                    else if ("DISABLED".startsWith(newBreak.toUpperCase()) && (newBreak.length() > 0))
                        newVal = 0;
                    else {
