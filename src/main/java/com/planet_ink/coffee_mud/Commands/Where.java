...
import com.planet_ink.coffee_mud.core.collections.MultiEnumeration;
        ...
        if ((CMSecurity.isAllowed(mob, mob.location(), CMSecurity.SecFlag.WHERE))
            ...
            if (who.length() == 0) {
                ...
                if ((who.toUpperCase().startsWith("EXIT "))
                    ...
                    exitOnly = true;
                    who = who.substring(5).trim();
                } else if ((who.toUpperCase().startsWith("ITEM "))
                    || (who.toUpperCase().startsWith("ITEMS"))) {
                    itemOnly = true;
                    who = who.substring(5).trim();
                } else if ((who.toUpperCase().startsWith("MOB "))
                    || (who.toUpperCase().startsWith("MOBS"))) {
                    mobOnly = true;
                    who = who.substring(4).trim();
                } else if (who.toUpperCase().startsWith("MOBMASK ") || who.toUpperCase().startsWith("MOBMASK=")) {
                    mobOnly = true;
                    zapperMask = true;
                ...
                } else if (who.toUpperCase().startsWith("ITEMMASK ") || who.toUpperCase().startsWith("ITEMMASK=")) {
                    itemOnly = true;
                    zapperMask = true;
                    who = who.substring(9).trim();
                    mob.tell(L("^xMask used:^?^.^N @x1\n\r", CMLib.masking().maskDesc(who)));
                    compiledZapperMask = CMLib.masking().maskCompile(who);
                } else if (who.toUpperCase().startsWith("MOBMASK2 ") || who.toUpperCase().startsWith("MOBMASK2=")) {
                    mobOnly = true;
                    zapperMask2 = true;
                    mob.tell(L("^xMask used:^?^.^N @x1\n\r", CMLib.masking().maskDesc(who)));
                    who = who.substring(9).trim();
                } else if (who.toUpperCase().startsWith("ITEMMASK2 ") || who.toUpperCase().startsWith("ITEMMASK2=")) {
                    itemOnly = true;
                    zapperMask2 = true;
                    mob.tell(L("^xMask used:^?^.^N @x1\n\r", CMLib.masking().maskDesc(who)));
