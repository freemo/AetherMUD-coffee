    ...
    public boolean execute(MOB mob, List<String> commands, int metaFlags)
        ...
        while (commands.size() > 0) {
            if (mskBunch != null) {
                ...
                commands.remove(0);
            } else if (commands.get(0).toString().equalsIgnoreCase("INAREA")) {
                ...
                commands.remove(0);
            } else if (commands.get(0).toString().equalsIgnoreCase("INWORLD")) {
                ...
                commands.remove(0);
            } else if (commands.get(0).toString().toUpperCase().startsWith("<MASK>")) {
                mskBunch = new XVector<String>(commands.get(0).toString().substring(6));
                commands.remove(0);
            } else if (commands.get(0).toString().equals("+PLAYERS")) {
