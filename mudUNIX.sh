...
nohup java -classpath ".:./lib/js.jar:./lib/jzlib.jar" -Djava.awt.headless=true -Xms65535000 -Xmx115535000 com.syncleus.aethermud.game.application.MUD "Your Muds Name Here" &
